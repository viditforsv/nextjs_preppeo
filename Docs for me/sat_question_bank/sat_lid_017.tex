...
% Lid Topic: Advanced Math — Nonlinear Systems in Two Variables
% Total Questions: 50

% --- PART 1: Core Nonlinear Intersections (1-25) ---
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw[red, thick] (-2.5,4) -- (2.5,4);
    \node[blue] at (1.5,2.5) {$y=x^2$};
    \node[red] at (1.5,4.5) {$y=4$};
\end{tikzpicture}
\end{center}
The graphs of $y = x^2$ and $y = 4$ are shown in the $xy$-plane above. What are the coordinates of the points of intersection?
\begin{tasks}(2)
    \task $(2, 4)$ and $(-2, 4)$
    \task $(4, 2)$ and $(4, -2)$
    \task $(2, 4)$ and $(0, 0)$
    \task $(\sqrt{2}, 4)$ and $(-\sqrt{2}, 4)$
\end{tasks}
...
\[ \begin{cases} y = x^2 \\ 3y + 6 = 3(x + 2) \end{cases} \]
\begin{tasks}(4)
    \task 1
    \task 2
    \task 3
...
\begin{tikzpicture}[scale=0.5]
    \draw[step=1cm, gray!20, very thin] (-5,-5) grid (5,5);
    \draw[->] (-5,0) -- (5,0) node[right] {$x$};
    \draw[->] (0,-5) -- (0,5) node[above] {$y$};
    \draw[thick, blue] (0,0) circle (4);
    \draw[thick, red] (-5,-1) -- (1,5);
    \node[blue] at (3.5,3.5) {$x^2+y^2=16$};
    \node[red] at (-4,1) {$y=x+4$};
\end{tikzpicture}
\end{center}
The graph of a circle and a line are shown above. Based on the graph, which of the following are the coordinates of the points of intersection?
\begin{tasks}(2)
    \task $(0, 4)$ and $(-4, 0)$
    \task $(4, 0)$ and $(0, -4)$
    \task $(0, 4)$ and $(4, 0)$
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw[domain=-2.2:2.2, smooth, variable=\x, red, thick] plot ({\x}, {-\x*\x + 4});
\end{tikzpicture}
\end{center}
The graph shows two parabolas, $y = x^2$ and $y = -x^2 + 4$. What are the $y$-coordinates of the intersection points?
\begin{tasks}(4)
    \task $y = 0$
    \task $y = 2$
    \task $y = 4$
...
% Category: Practice | Difficulty: Hard | Question Type: Numeric Entry
\question
If $(x_1, y_1)$ and $(x_2, y_2)$ are the two solutions to the system of equations below, what is the value of $y_1 + y_2$?
\[ \begin{cases} y = x^2 + 2x + 1 \\ x + y + 1 = 0 \end{cases} \]
...
\textbf{Calculation and Logic:} \\
Slope $m = \frac{8000 - 12000}{50 - 30} = \frac{-4000}{20} = -200$ units per dollar.

\vspace{10pt}

Use the point $(50, 8000)$ and the target price \$45: \\
Price decreased by \$5 from the \$50 mark. \\
Since the slope is $-200$, a decrease of \$5 in price leads to an \textit{increase} in demand. \\
Change in $Q = -200 \times (-5) = 1000$.
...
\question
$v = 18t$ \\
The given equation represents the velocity $v$, in feet per second, of a falling object where $t$ represents the time, in seconds, since it was released. Which of the following is the best interpretation of 18 in this context?
\begin{tasks}(1)
    \task The object fell a total of 18 feet.
    \task The object's velocity increases by 18 feet per second every second.
    \task The object was released from a height of 18 feet.
    \task The object reached a maximum velocity of 18 feet per second.
\end{tasks}
...
Complete the square by adding $(\frac{-4}{2})^2 = 4$ to both sides: \\
$x^2 - 4x + 4 = 5 + 4$ \\
$(x - 2)^2 = 9$
...
\begin{center}
\begin{tikzpicture}[scale=0.6]
    \draw[step=1cm,gray!20,very thin] (-3,-1) grid (3,8);
    \draw[->] (-3,0) -- (3,0) node[right] {$x$};
    \draw[->] (0,-1) -- (0,8) node[above] {$y$};
    \draw[thick, blue] (-1.5,7) -- (1.5,-1);
    \node at (2,1) {$L$};
\end{tikzpicture}
\end{center}
...
Set up two cases: \\
Case 1: $x - 5 = 3 \Rightarrow x = 8$ \\
Case 2: $x - 5 = -3 \Rightarrow x = 2$
...
\question
$x^2 - kx + 16 = 0$ \\
In the given equation, $k$ is a constant. If the equation has exactly one real solution, what is a possible value of $k$?
\begin{tasks}(4)
    \task 4
    \task 8
    \task 12
...
\question
$a = \frac{v_f - v_i}{t}$ \\
The formula above relates acceleration $a$, final velocity $v_f$, initial velocity $v_i$, and time $t$. Which of the following expresses $v_f$ in terms of $a, t,$ and $v_i$?
\begin{tasks}(2)
    \task $v_f = at + v_i$
    \task $v_f = at - v_i$
    \task $v_f = \frac{a}{t} + v_i$
    \task $v_f = a(t + v_i)$
\end{tasks}
...
Find $a$ ($x$-intercept): $0 = 5x + 30 \Rightarrow -30 = 5x \Rightarrow x = -6$. So $a = -6$.
...
Answer: \colorbox{yellow!100}{A}
\end{solution}
% --- PART 2: Advanced Nonlinear Systems & Multi-Step Logic (26-50) ---
...
% Category: Practice | Difficulty: Hard | Question Type: Numeric Entry
\question
If $(x, y)$ is a solution to the system of equations below and $x > 0$, what is the value of $xy$?
\[ \begin{cases} y = x^2 - 4 \\ y = -x^2 + 4 \end{cases} \]
...
$y = 2x^2 - 21x + 64$ \\
$y = 3x + a$ \\
In the given system of equations, $a$ is a constant. If the graphs of the equations intersect at exactly one point $(x, y)$, what is the value of $x$?
\begin{tasks}(4)
    \task -8
    \task -6
    \task 6
...
\textbf{Calculation and Logic:} \\
From the first equation: $x + 7 = 10 \Rightarrow x = 3$.
...
\question
$v^2 = \frac{LT}{m}$ \\
The formula above expresses the square of the speed $v$ of a wave in terms of tension $T$, mass $m$, and length $L$. Which of the following expresses $T$ in terms of $m, v,$ and $L$?
\begin{tasks}(2)
    \task $T = \frac{mv^2}{L}$
    \task $T = \frac{m}{v^2L}$
    \task $T = \frac{mL}{v^2}$
...
Answer: \colorbox{yellow!100}{231}
\end{solution}
...
$y = x^2$ \\
$y = 6x + 7$ \\
If $(x, y)$ is a solution to the system above and $x < 0$, what is the value of $y$?
\begin{tasks}(4)
    \task -1
    \task 1
    \task 7
...
\question
$y = ax^2 - c$ \\
In the equation above, $a$ and $c$ are positive constants. How many times does the graph of the equation intersect the line $y = a + c$?
\begin{tasks}(4)
    \task Zero
    \task One
    \task Two
...
\textbf{Calculation and Logic:} \\
Find the vertex $x$-coordinate: $x = -(-4) / (2 \times 2) = 1$. \\
...
$8x + y = -11$ \\
$2x^2 = y + 341$ \\
The graphs of the equations intersect at point $(x, y)$. What is a possible value of $x$?
...
The equation becomes: $\frac{1}{u^2} = 4$ \\
$1 = 4u^2$ \\
$u^2 = 0.25$ \\
$u = \pm 0.5$
...
\question
$v = -\frac{w}{150x}$ \\
The given equation relates positive numbers $v, w,$ and $x$. Which equation correctly expresses $w$ in terms of $v$ and $x$?
\begin{tasks}(2)
    \task $w = -150vx$
    \task $w = -\frac{150v}{x}$
    \task $w = -\frac{x}{150v}$
...
$y = -1.5$ \\
$y = x^2 + 8x + a$ \\
In the given system, $a$ is a positive constant. If the system has exactly one solution, what is the value of $a$?
\begin{tasks}(4)
    \task 14.5
    \task 16
    \task 17.5
...
Answer: \colorbox{yellow!100}{29/3}
\end{solution}
...
$x = 49$ \\
$y = \sqrt{x} + 9$ \\
The graphs of the equations intersect at the point $(x, y)$. What is the value of $y$?
\begin{tasks}(4)
    \task 16
    \task 40
    \task 81
