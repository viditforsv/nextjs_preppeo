...
% Lid 040: Problem-Solving & Data Analysis
% Topic: Inference: Inference from samples, margin of error, and Sample Validity
...
\begin{tasks}(1)
    \task Approximately 3\% of the teens in the study who are classified as heavy texters are not really heavy texters.
    \task It is not possible that the percent of all US teens who are heavy texters is less than 27\%.
    \task The percent of all US teens who are heavy texters is 33\%.
    \task It is doubtful that the percent of all US teens who are heavy texters is 35\%.
\end{tasks}
...
A researcher interviewed 411 randomly selected US residents. If the population of the United States was 300 million when the survey was given, what is the best estimate, in millions, of the difference between the number of US residents who favor (somewhat or strongly) and those who oppose (somewhat or strongly) the use of nuclear energy? (Round to the nearest whole number).
\begin{center}
\textbf{Views on Nuclear Energy Use}
\begin{tabular}{|l|c|}
\hline
\textbf{Response} & \textbf{Frequency} \\ \hline
Strongly favor & 56 \\ \hline
Somewhat favor & 214 \\ \hline
Somewhat oppose & 104 \\ \hline
Strongly oppose & 37 \\ \hline
\end{tabular}
\end{center}
\begin{solution}
\textbf{Conceptual Explanation:} \\
...
\begin{tasks}(1)
    \task The majority of all fish in the pond weigh less than 2 pounds.
    \task The average weight of all fish in the pond is approximately 2 pounds.
    \task Approximately 30\% of all fish in the pond weigh more than 2 pounds.
    \task Approximately 30\% of all largemouth bass in the pond weigh more than 2 pounds.
\end{tasks}
...
\begin{tasks}(1)
    \task It is likely that all visitors hiked between 4 and 5 miles.
    \task It is likely that most visitors hiked exactly 4.5 miles.
    \task It is not possible that any visitor hiked less than 3 miles.
    \task It is plausible that the mean distance hiked for all visitors is between 4 and 5 miles.
\end{tasks}
...
\begin{tasks}(1)
    \task Surveying 100 students at a local library.
    \task Surveying 100 students from the city's highest-performing high school.
    \task Surveying 100 students selected at random from the city's school enrollment records.
    \task Surveying 100 students who volunteer to participate after an announcement at a sports event.
\end{tasks}
...
\begin{tasks}(1)
    \task The sample size is too large.
    \task The survey was not mailed to everyone.
    \task Nonresponse bias, because those who feel strongly are more likely to respond.
    \task The survey was sent at the wrong time of year.
\end{tasks}
...
\begin{tasks}(1)
    \task Every commuter in the city has a commute between 25 and 35 minutes.
    \task Most commuters in the city have a commute of exactly 30 minutes.
    \task The true mean commute time for all commuters is likely between 25 and 35 minutes.
    \task The study is invalid because the sample size is only 50.
\end{tasks}
...
\begin{tasks}(1)
    \task The sample must include at least half of the population.
    \task The sample must be selected randomly from the population.
    \task The sample must be taken from people who are interested in the study.
    \task The sample must be as large as possible regardless of selection method.
\end{tasks}
...
\begin{tasks}(1)
    \task Nonresponse bias
    \task Undercoverage bias, because it only surveys people already at the movie.
    \task Measurement bias, because people may lie about liking the movie.
    \task No bias is present because it is a random sample of moviegoers.
\end{tasks}
...
\begin{tasks}(1)
    \task It would double to 3.0\%.
    \task It would stay at 1.5\%.
    \task It would decrease to approximately 0.75\%.
    \task It would decrease to 0\%.
\end{tasks}
...
\textbf{Calculation and Logic:} \\
Lower bound percentage: $22\% - 4\% = 18\%$. Upper bound percentage: $22\% + 4\% = 26\%$. Apply these to the population of 10,000: $0.18 \times 10,000 = 1,800$ and $0.26 \times 10,000 = 2,600$. The plausible number of supporters is between 1,800 and 2,600.
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Sample proportion: $15 / 500 = 0.03$. Apply to the total batch: $0.03 \times 12,000$. $3 \times 120 = 360$. The estimated number of defective bulbs is 360.
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Set up a proportion: $\frac{\text{Tagged Sample}}{\text{Total Sample}} = \frac{\text{Total Tagged}}{\text{Total Population}}$. $\frac{5}{100} = \frac{40}{x}$. Cross multiply: $5x = 4,000$. Divide by 5: $x = 800$. The total population is estimated to be 800.
...
\begin{tasks}(1)
    ...
    \task Decreasing the sample size.
    \task Changing the survey questions to be more general.
\end{tasks}
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Max percentage: $14\% + 1.5\% = 15.5\%$. Convert to decimal: $0.155$. Multiply by total households: $50,000 \times 0.155$. $50 \times 155 = 7,750$. The maximum plausible number is 7,750.

\vspace{30pt}

Answer: \colorbox{yellow!100}{7750}
\end{solution}
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Percentage who do not take the bus: $100\% - 25\% = 75\%$. Apply to total population: $1,200 \times 0.75 = 900$.
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Sample proportion: $2 / 800 = 1 / 400 = 0.0025$. Multiply by population: $40,000 \times 0.0025 = 100$.
...
\begin{tasks}(1)
    \task 3% of the people in the sample lied.
    \task 3% of the total population was not reached.
    \task The actual population percentage is likely between 37% and 43%.
    \task The poll is exactly 3% away from being perfectly accurate.
\end{tasks}
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Interval is $12 - 2 = 10$ to $12 + 2 = 14$. Width = Upper Bound $-$ Lower Bound. $14 - 10 = 4$. (Alternatively, width is always $2 \times$ margin of error). $2 \times 2 = 4$.
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Proportion: $10 / 50 = 1 / 5 = 0.2$. Population estimate: $1,500 \times 0.2 = 300$.
...
\begin{tasks}(4)
    \task Random sampling
    \task Cluster sampling
    \task Stratified sampling
    \task Convenience sampling
\end{tasks}
...
\begin{tasks}(4)
    \task It is divided by 10.
    \task It is divided by 100.
...
\begin{solution}
\textbf{Calculation and Logic:} \\
Min percentage: $30\% - 2.5\% = 27.5\%$. Convert to decimal: $0.275$. Multiply by population: $20,000 \times 0.275 = 5,500$.

\vspace{30pt}

Answer: \colorbox{yellow!100}{5500}
\end{solution}
...
\begin{tasks}(1)
    \task To make the survey easier to conduct.
    \task To ensure the sample is as small as possible.
    \task To ensure every individual in the population has an equal chance of being selected.
    \task To guarantee the sample results are 100% accurate.
\end{tasks}
...
\begin{tasks}(4)
    \task It would double to 6%.
    \task It would decrease to 1.5%.
    \task It would stay approximately 3%.
    \task It would decrease to 0%.
\end{tasks}
