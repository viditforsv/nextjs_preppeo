-- R&W practice questions from Google Sheets — domain: craft-structure
-- Source: spreadsheet 1MPX_GCvWtecZ2saelOXNm0R4GfWhReR67vdqf_IN9tU
-- 318 questions total, qc_done=false (needs review before going live)
...
-- Text Structure and Purpose | 82cb7dda | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It describes an experimental method of measuring the strength of physiological responses in humans."},{"id":"b","text":"It illustrates processes by which certain insects can express how they are feeling. It summarizes a finding suggesting that some mechanisms in the brains of certain insects resemble mechanisms in"},{"id":"c","text":"mammalian brains. It presents research showing that certain insects and mammals behave similarly when there is a possibility of a"},{"id":"d","text":"reward for their actions."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | c966ad55 | easy
(
  'mcq',
  'rw',
  'The following text is from Srimati Svarna Kumari Devi''s 1894 novel The Fatal Garland (translated by',
  '[{"id":"a","text":"Christina Albers in 1910). Shakti is walking near a riverbank that she visited frequently during her childhood. She crossed the woods she knew so well. The trees seemed to extend their branches like welcoming arms. They greeted her as an old friend. Soon she reached the river-side. Which choice best describes the function of the underlined portion in the text as a whole? A. It suggests that Shakti feels uncomfortable near the river."},{"id":"b","text":"It indicates that Shakti has lost her sense of direction in the woods."},{"id":"c","text":"It emphasizes Shakti''s sense of belonging in the landscape."},{"id":"d","text":"It conveys Shakti''s appreciation for her long-term friendships."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 2af2016f | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To describe a widely held belief and how a study''s results support that belief"},{"id":"b","text":"To argue that researchers were surprised by the results of a certain study"},{"id":"c","text":"To suggest ways to improve a certain study''s experimental design"},{"id":"d","text":"To explain a study''s conclusion and how a research team arrived at that conclusion"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | e818241b | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It describes a serious limitation of the method used by Nance and colleagues."},{"id":"b","text":"It presents the central finding reported by Nance and colleagues."},{"id":"c","text":"It identifies the problem that Nance and colleagues attempted to solve but did not."},{"id":"d","text":"It explains how the work of Nance and colleagues was received by others in the field."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 236fee8e | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"inconclusive. It provides information that helps support a claim about a discovery''s significance that is presented in the following"},{"id":"b","text":"sentence."},{"id":"c","text":"It traces the steps that were taken to locate and recover the objects that are described in the previous sentence."},{"id":"d","text":"It outlines a hypothesis that additional evidence discussed in the following sentence casts some doubt on."}]'::jsonb,
  'b',
  'Choice B is the best answer. The underlined sentence provides information about import/export firms, showing how Chinese communities across the world were connected by trade routes. Choice A is incorrect. The underlined sentence never suggests that the countries of origin of the fish are in question-in fact, it tells us exactly where they came from. Choice C is incorrect. The passage never describes the steps taken to discover the fish bones described in the previous sentence. Choice D is incorrect. The underlined sentence doesn''t outline a hypothesis but instead provides evidence. And the following sentence agrees with the underlined sentence, so we could eliminate this choice just for saying that the following sentence "casts some doubt on" the underlined one- partly wrong is all wrong.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Text Structure and Purpose | 7d8224f9 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To discuss the benefits of studying mapmaking"},{"id":"b","text":"To explain how travelers created maps"},{"id":"c","text":"To describe a collection of medieval maps and how it was created"},{"id":"d","text":"To compare medieval Arabic and Greek mapmaking techniques"}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 2903a041 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It discusses a method used by some researchers, then states why an alternative method is superior to it."},{"id":"b","text":"It describes how researchers made a scientific discovery, then explains the importance of that discovery."},{"id":"c","text":"It outlines the steps taken in a scientific study, then presents a hypothesis based on that study. It examines how a group of scientists reached a conclusion, then shows how other scientists have challenged that"},{"id":"d","text":"conclusion."}]'::jsonb,
  'b',
  'Choice B is the best answer. The text begins by describing how the researchers used the JWST to detect CO₂ in WASP- 39b''s atmosphere. Then the text discusses the significance of this finding, both as the first evidence of CO₂ in an exoplanet''s atmosphere and as an illustration of the JWST''s potential for making new discoveries in general. Choice A is incorrect. The text doesn''t compare two different methods, but rather focuses on one study that used the JWST. Choice C is incorrect. The text doesn''t present a hypothesis, but rather reports on the findings of a study. Choice D is incorrect. The text doesn''t mention any scientists challenging the conclusion reached by López-Morales and colleagues.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Text Structure and Purpose | 066a3295 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It dismisses as untrue the research presented in the previous sentence."},{"id":"b","text":"It defines a term used in the description that follows in the rest of the sentence."},{"id":"c","text":"It emphasizes the main goal of the research introduced in the previous sentence."},{"id":"d","text":"It provides context that clarifies the significance of the information that follows in the rest of the sentence."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | ac9a3a26 | hard
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 03c9f327 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To convey a contrast between Jane''s outward calmness and internal restlessness"},{"id":"b","text":"To emphasize Jane''s loyalty to the people she works for at Thornfield Hall"},{"id":"c","text":"To demonstrate that Jane finds her situation both challenging and deeply fulfilling"},{"id":"d","text":"To describe Jane''s determination to secure employment outside of Thornfield Hall"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 47598085 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It defines a phenomenon that is discussed in the text."},{"id":"b","text":"It introduces a problem that is examined in the text."},{"id":"c","text":"It makes a claim that is challenged in the text."},{"id":"d","text":"It presents a hypothesis that is evaluated in the text."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | b0f7541b | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It portrays the thoughts of a character who is embarrassed about his own behavior."},{"id":"b","text":"It presents an account of a misunderstanding."},{"id":"c","text":"It offers a short history of how a person came to be famous."},{"id":"d","text":"It explains why one character dislikes another."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | 4c4db685 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It elaborates on the previous sentence''s statement about a transitional moment in Johnson''s artistic career. It provides information about Johnson''s travels in support of a claim about his artistic influences, which is advanced"},{"id":"b","text":"in the following sentence. It recounts a moment in Johnson''s personal life that enabled the success of his subsequent career, which is"},{"id":"c","text":"summarized in the following sentence. It presents evidence that calls into question the previous sentence''s characterization of Johnson''s artistic"},{"id":"d","text":"development."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 617a8a10 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To describe an approach a team of scientists used to study pollinators"},{"id":"b","text":"To question a claim scientists make about pollinators"},{"id":"c","text":"To explain why moths prefer red clover to other flowers"},{"id":"d","text":"To announce an unexpected research finding about red clover"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | df46a2ee | medium
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | ff97fd53 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To explain what motivated Algarín to found the Nuyorican Poets Cafe"},{"id":"b","text":"To situate the Nuyorican Poets Cafe within the cultural life of New York as a whole"},{"id":"c","text":"To discuss why the Nuyorican Poets Cafe expanded its scope to include art and music"},{"id":"d","text":"To provide an overview of the founding and mission of the Nuyorican Poets Cafe"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | c61a7c4a | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"O''Brien and Ahmed''s study. It presents the study by O''Brien and Ahmed to critique the methods and results reported in previous studies of the"},{"id":"b","text":"effects of posture on cognition. It explains a significant problem in the emerging understanding of posture''s effects on cognition and how O''Brien and"},{"id":"c","text":"Ahmed tried to solve that problem. It discusses the study by O''Brien and Ahmed to illustrate why caution is needed when making claims about the"},{"id":"d","text":"effects of posture on cognition."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | aa5897b8 | hard
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 9421ed62 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To discuss von Ahn''s invention of reCAPTCHA"},{"id":"b","text":"To explain how digital scanners work"},{"id":"c","text":"To call attention to von Ahn''s book-digitizing project"},{"id":"d","text":"To indicate how popular reCAPTCHA is"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 39857700 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It creates a detailed image of the physical setting of the scene."},{"id":"b","text":"It establishes that a character is experiencing an internal conflict."},{"id":"c","text":"It makes an assertion that the next sentence then expands on."},{"id":"d","text":"It illustrates an idea that is introduced in the previous sentence."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | e929fe98 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To provide examples of Price''s importance as a composer"},{"id":"b","text":"To argue that more major orchestras should perform Price''s compositions"},{"id":"c","text":"To describe the musical styles that inspired many of Price''s symphonies"},{"id":"d","text":"To compare Price''s scores with those of classical European composers"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 2aaee77f | easy
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 2e744883 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It underscores the extent of the CEP''s impact on the Civil Rights Movement of the 1960s."},{"id":"b","text":"It illustrates the CEP organizers'' efforts to educate participants on a wide variety of topics. It suggests that CEP attendees held a diverse array of opinions about the Southern Christian Leadership Conference''s"},{"id":"c","text":"political philosophy. It establishes that criticism of the CEP was limited to a few individuals in the Southern Christian Leadership"},{"id":"d","text":"Conference."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | b4887dae | hard
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | cf9a00e0 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To contrast the conditions in the Atacama Desert with those on Mars"},{"id":"b","text":"To explain why many life-forms cannot survive in the Atacama Desert"},{"id":"c","text":"To indicate why astrobiologists choose to conduct research in the Atacama Desert"},{"id":"d","text":"To describe certain limitations to conducting scientific study in the Atacama Desert"}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 3e6ad72d | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To summarize the results of the team''s analysis"},{"id":"b","text":"To present a specific example that illustrates the study''s findings"},{"id":"c","text":"To explain part of the methodology used in the team''s study"},{"id":"d","text":"To call out a challenge the team faced in conducting its analysis"}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 6f5fc289 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To emphasize the uniformity of both the town and the people who live there"},{"id":"b","text":"To explain the limited work opportunities available to the town''s residents"},{"id":"c","text":"To reveal how the predictability of the town makes it easy for people lose track of time"},{"id":"d","text":"To argue that the simplicity of life in the town makes it a pleasant place to live"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 5336f2e4 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It provides an extended description of a location that John likes to visit."},{"id":"b","text":"It reveals that some residents of John''s town are confused by his behavior."},{"id":"c","text":"It illustrates the uniqueness of John''s imagination compared to the imaginations of other children."},{"id":"d","text":"It suggests that John longs to experience a larger life outside the Florida woods."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | ea971260 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To portray Polly''s reaction to Fanny''s friends"},{"id":"b","text":"To identify the topics Polly talks about with Fanny''s friends"},{"id":"c","text":"To explain how Fanny met some of her friends"},{"id":"d","text":"To illustrate how Fanny''s friends feel about Polly"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 2b085bc6 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It illustrates a character''s reaction to a new environment."},{"id":"b","text":"It explains why a character has traveled to a city."},{"id":"c","text":"It compares a character''s thoughts about an event at two different times of day."},{"id":"d","text":"It presents a character feeling regret over leaving home."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 213a25d1 | medium
(
  'mcq',
  'rw',
  'The following text is from Paul Laurence Dunbar''s 1913 poem "The Poet and His Song." A song is but a little thing, And yet what joy it is to sing! In hours of toil it gives me zest, And when at eve I long for rest; When cows come home along the bars, And in the fold I hear the bell, As Night, the shepherd, herds his stars, I sing my song, and all is well. Which choice best states the main purpose of the text?',
  '[{"id":"a","text":"To convey how engaging in song makes the speaker feel"},{"id":"b","text":"To compare the speaker to a singing shepherd"},{"id":"c","text":"To portray the speaker''s excitement about farming"},{"id":"d","text":"To describe the pieces of music the speaker enjoys hearing"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | c8603ed7 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To compare the Balmy Alley murals to other murals in San Francisco"},{"id":"b","text":"To offer an overview of the history and importance of the Balmy Alley murals"},{"id":"c","text":"To urge people to protect the murals of San Francisco from decay"},{"id":"d","text":"To describe the rise of mural painting in San Francisco beginning in the 1970s"}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | 9c759a09 | easy
(
  'mcq',
  'rw',
  'Go forth, my son, Winged by my heart''s desire! Great reaches, yet unknown, Await For your possession. I may not, if I would, Retrace the way with you, My pilgrimage is through, The following text is from Georgia Douglas Johnson''s 1922 poem "Benediction." But life is calling you! Which choice best states the main purpose of the text?',
  '[{"id":"a","text":"To express hope that a child will have the same accomplishments as his parent did"},{"id":"b","text":"To suggest that raising a child involves many struggles"},{"id":"c","text":"To warn a child that he will face many challenges throughout his life"},{"id":"d","text":"To encourage a child to embrace the experiences life will offer"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 8963273a | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It presents a claim about Mitchell, then gives an example supporting that claim."},{"id":"b","text":"It discusses Van Gogh''s influence on Mitchell, then considers Mitchell''s influence on other artists."},{"id":"c","text":"It describes a similarity between two artists, then notes a difference between them."},{"id":"d","text":"It describes the songs on Turbulent Indigo, then explains how they relate to the album''s cover."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | c4900368 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To consider how the repetitiveness inherent in human life can be both rewarding and challenging To question whether activities completed at one time of day are more memorable than those completed at another"},{"id":"b","text":"time of day"},{"id":"c","text":"To refute the idea that joy is a more commonly experienced emotion than sadness is"},{"id":"d","text":"To demonstrate how the experiences of individuals relate to the experiences of their communities"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | a68239ed | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It reinforces the text''s skepticism about the possibility of truly achieving self-knowledge."},{"id":"b","text":"It speculates that some readers will share the doubts expressed in the text about the value of self-knowledge."},{"id":"c","text":"It cautions readers that the text''s directions for how to achieve self-knowledge are hard to follow."},{"id":"d","text":"It concedes that the definition of self-knowledge advanced in the text is unpopular."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 422c5068 | medium
(
  'mcq',
  'rw',
  'Generally it takes Tule geese about four days to migrate south for the winter. From their summer breeding grounds in Cook Inlet, Alaska, the birds begin by flying over the Gulf of Alaska, keeping about 100 miles from the Canadian shore. They pause to rest on the Pacific Ocean, then fly toward Summer Lake, Oregon, before finally arriving at their winter destination of Sacramento Valley, California. In 2020, however, it took the geese over twice as long to make their way from Cook Inlet to Sacramento Valley. According to researchers, the reason was airborne pollutants. Which choice best states the function of the underlined portion in the text as a whole?',
  '[{"id":"a","text":"It illustrates a change in Tule geese''s usual flight behavior."},{"id":"b","text":"It suggests an explanation for why Tule geese breed in Alaska."},{"id":"c","text":"It describes part of the Tule geese''s typical winter migration journey."},{"id":"d","text":"It compares Tule geese to other birds that migrate south for the winter."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 74446089 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It urges contemporary musicians to adopt the unique sound of Keyboard Fantasies."},{"id":"b","text":"It responds to criticism of Keyboard Fantasies by some younger musicians."},{"id":"c","text":"It offers examples of younger musicians whose work has been impacted by Keyboard Fantasies."},{"id":"d","text":"It contrasts Keyboard Fantasies with the recordings of two younger musicians."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | a2dd51c1 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To explain an effort made by the city of Portland to reduce demolition waste and some results of that effort"},{"id":"b","text":"To show that popular support for measures that reduce demolition waste has increased since 2019"},{"id":"c","text":"To argue that building deconstruction is not as effective as other measures at reducing demolition waste"},{"id":"d","text":"To discuss laws aimed to reduce demolition waste in Portland and compare them to similar laws in other cities"}]'::jsonb,
  'a',
  'Choice A is the best answer. The author first describes a Portland law aimed at reducing demolition waste, and then goes on to explain that 27% of materials from building deconstructions were able to be reused and the rest were recycled. Choice B is incorrect. The text never discusses the popularity of the law. Choice C is incorrect. The text never compares building deconstruction to other measures designed to reduce demolition waste. Choice D is incorrect. The text never mentions laws in cities other than Portland, Oregon.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Text Structure and Purpose | 48e4021d | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It explains why the narrator always wanted a piano close to her bedroom."},{"id":"b","text":"It establishes how the narrator feels about the piano."},{"id":"c","text":"It suggests that the narrator''s brothers are talented piano players."},{"id":"d","text":"It describes the event that led the narrator''s parents to buy a piano."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | f2c48e47 | medium
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 1b5d4e3e | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It defines a scientific term used in the sentence that follows."},{"id":"b","text":"It contradicts a description in the sentence that follows."},{"id":"c","text":"It provides an answer to the question in the previous sentence."},{"id":"d","text":"It notes that the question in the previous sentence has not been researched."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | e5da61f1 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To compare the narrator''s reaction to a new home with his wife''s reaction"},{"id":"b","text":"To give an example of Julius''s knowledge about soil"},{"id":"c","text":"To show that the narrator and Julius often hunt and fish together"},{"id":"d","text":"To explain different ways in which Julius was helpful"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 2d77660e | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To compare Spanish-language newspapers published in Texas today with ones published there during the late 1800s"},{"id":"b","text":"To explain that Spanish-language newspapers thrived in Texas and especially in El Paso during the late 1800s To argue that Spanish-language newspapers published in El Paso influenced the ones published in San Antonio"},{"id":"c","text":"during the late 1800s"},{"id":"d","text":"To explain why Spanish-language newspapers published in Texas were so popular in Mexico during the late 1800s"}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | af43b0bd | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To argue for the significance of new findings amid an ongoing debate among researchers"},{"id":"b","text":"To discuss the advantages and disadvantages of the method used in an experiment"},{"id":"c","text":"To summarize two competing hypotheses and a major finding associated with each one"},{"id":"d","text":"To describe an experiment whose results cast doubt on an established hypothesis"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 6ae393f7 | hard
(
  'mcq',
  'rw',
  'Asteroid 6478 Gault has experienced intermittent mass loss since at least 2013, but in contrast to some other asteroids with repeated mass-loss episodes, 6478 Gault has not lost mass at its perihelion (the closest point of its orbit to the Sun), and thus the loss is not attributable to solar energy-driven ice vaporization. And as Jane X. Luu et al. point out, the singular nature of impact ejection makes it untenable as an account of multiple loss episodes of similar duration over several years. Instead, Luu et al. are likely correct that 6478 Gault is shedding mass due to rotational instability. Which choice best describes the overall structure of the text? It presents a scientific observation, describes a contrast between that observation and other observations, and then',
  '[{"id":"a","text":"explains why those other observations should not be considered credible. It describes an astronomical finding, discusses competing theories about that finding that the author regards as"},{"id":"b","text":"flawed, and then describes new evidence that supports an alternative theory. It introduces a natural phenomenon, refutes two potential explanations for that phenomenon, and then presents a"},{"id":"c","text":"third explanation for that phenomenon that the author regards as plausible. It discusses a physical process, evaluates possible causes of that process, and then states that a persuasive account"},{"id":"d","text":"of the process has yet to be put forward."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 54c6128b | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It presents a conclusion about Roman trade routes based on the team''s findings."},{"id":"b","text":"It questions how the team was able to conclude that the planks were used to build a boat."},{"id":"c","text":"It explains why the planks were made from oak rather than a different kind of wood."},{"id":"d","text":"It describes common methods used in Roman subway construction."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 0ed94d4c | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To show how Ormes''s Torchy Brown inspired other Black women to write comic strips in the 1930s"},{"id":"b","text":"To illustrate how the subjects Ormes addressed in her comic strips changed over the course of her career"},{"id":"c","text":"To give an example of how Ormes presented the experiences of Black Americans in her comic strips"},{"id":"d","text":"To claim that several characters in Torchy Brown were based on people that Ormes knew personally"}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 0a04cac5 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To offer Tom''s assurance that the play will be inoffensive and involve only a small number of people"},{"id":"b","text":"To clarify that the play will not be performed in the manner Tom had originally intended"},{"id":"c","text":"To elaborate on the idea that the people around Tom lack the skills to successfully stage a play"},{"id":"d","text":"To assert that Tom believes the group performing the play will be able to successfully promote it"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 1d9a09c0 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To give a reason why the narrator is excited to start middle school"},{"id":"b","text":"To describe an activity that the narrator finds amusing"},{"id":"c","text":"To explain a problem that the narrator has overcome"},{"id":"d","text":"To discuss a movie that the narrator saw in a theater"}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | fcc328c6 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It presents Melisa Diaz''s remarks about difficulties that her team encountered."},{"id":"b","text":"It introduces a scientific term that is used in the discussion that follows."},{"id":"c","text":"It emphasizes the surprising nature of the findings that are presented."},{"id":"d","text":"It explains the difference between two kinds of geological material."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | a70cbc53 | hard
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | a2be625e | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To convey the worries brought about by a new guest"},{"id":"b","text":"To describe how the characters have changed over time"},{"id":"c","text":"To contrast the activity indoors with the stillness outside"},{"id":"d","text":"To depict the setting as the characters await a visitor''s arrival"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 5e732e67 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"The text identifies a complex problem, then presents examples of unsuccessful attempts to solve that problem."},{"id":"b","text":"The text summarizes a debate among researchers, then gives reasons for supporting one side in that debate."},{"id":"c","text":"The text describes a general situation, then illustrates that situation with specific examples. The text discusses several notable individuals, then explains commonly overlooked differences between those"},{"id":"d","text":"individuals."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | d9e55268 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To suggest that some tribal members refuse to sign the petition because they dislike Louis Pipestone"},{"id":"b","text":"To show that attitudes toward the petition within the tribal community change over time"},{"id":"c","text":"To demonstrate that most tribal members are enthusiastic about signing the petition"},{"id":"d","text":"To portray Louis Pipestone''s strong commitment to collecting signatures for the petition"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 14b7dced | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"The speaker questions an increasingly prevalent attitude, then summarizes his worldview."},{"id":"b","text":"The speaker regrets his isolation from others, then predicts a profound change in society."},{"id":"c","text":"The speaker concedes his personal shortcomings, then boasts of his many achievements."},{"id":"d","text":"The speaker addresses a criticism leveled against him, then announces a grand ambition of his."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 56ec23a0 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It introduces an artist and then explains some common characteristics of well-known paintings by that artist."},{"id":"b","text":"It explains a specific painting technique and then provides examples of artists who use the technique."},{"id":"c","text":"It describes a famous painting and then compares it to a lesser-known painting from the same time period."},{"id":"d","text":"It gives an opinion on an artist and then suggests multiple reasons why the artist''s work has been largely overlooked."}]'::jsonb,
  'a',
  'Choice A is the best answer. The first sentence introduces Senju as a famous artist, while the next three sentences describe the defining features of his art, such as it only showing part of the waterfall and its origins in US art movements and Japanese techniques. Choice B is incorrect. The text doesn''t provide examples of any other artists who use Senju''s techniques. Choice C is incorrect. The text doesn''t describe any single famous painting or make comparisons between paintings. Choice D is incorrect. The text doesn''t provide an opinion on Senju (just facts), nor does it suggest that his art has been overlooked- in fact, it states that he is "known worldwide."',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Text Structure and Purpose | 1c6b1fa0 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It emphasizes Ac Ko Mok Ki''s desire to represent other tribes on the map."},{"id":"b","text":"It explains how Ac Ko Mok Ki developed an interest in mapmaking."},{"id":"c","text":"It identifies some reasons why the map is impressive."},{"id":"d","text":"It details how the map was used for hunting and trading purposes."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 6d44060a | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"works in that field are more comprehensive than others. It mentions two renowned works and then claims that despite their popularity it is impossible for these works to"},{"id":"b","text":"serve the purpose their authors intended. It summarizes the history of a field of thought by discussing two works and then proposes a topic of further research"},{"id":"c","text":"for specialists in that field."},{"id":"d","text":"It describes two influential works and then explains why one is more widely read than the other."}]'::jsonb,
  'a',
  'Choice A is the best answer. The text starts by stating what moral philosophy is concerned with and naming two examples of works in the field. Then it describes a shortcoming of some works in that field (they say how but not why), and finally it states that other works try to avoid that shortcoming (by including both how and why to live a morally good life). Choice B is incorrect. This is too extreme. The text never mentions whether the two works are popular or not, and it never argues that these works don''t serve their intended purpose of describing how to live a morally good life. Rather, the text claims that works of moral philosophy that don''t include both how and why to be moral are not useful to readers who don''t already want to be moral. Choice C is incorrect. This isn''t the overall structure. The text never discusses the history of moral philosophy at all, and it doesn''t propose any topic for further research. Choice D is incorrect. This isn''t the overall structure. The text never discusses which of the two works is more widely read.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Text Structure and Purpose | 590f0ad2 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It challenges a common assumption about the species under investigation in the research referred to in the text."},{"id":"b","text":"It introduces discussion of a specific example that supports the general claim made in the previous sentence."},{"id":"c","text":"It suggests that a certain species should be included in additional studies like the one mentioned later in the text."},{"id":"d","text":"It provides a definition for an unfamiliar term that is central to the main argument in the text."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | 19688783 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To demonstrate that Anne has a newly developed appreciation of nature"},{"id":"b","text":"To describe an argument that Anne and Marilla often have"},{"id":"c","text":"To emphasize Marilla''s disapproval of how Anne has decorated her room"},{"id":"d","text":"To show that Anne and Marilla have very different personalities"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | d69bc408 | medium
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 02e49a0c | easy
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | d563bf65 | easy
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To compare basketball with other sports"},{"id":"b","text":"To provide details of how to play basketball"},{"id":"c","text":"To state how players will be chosen for the basketball team"},{"id":"d","text":"To explain why the narrator thinks she might make the basketball team"}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | 97360a00 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It presents alternating descriptions of night in a rural area and in a city."},{"id":"b","text":"It sketches an image of nightfall, then an image of sunrise."},{"id":"c","text":"It makes an extended comparison of night to a human being."},{"id":"d","text":"It portrays how night changes from one season of the year to the next."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | aa7fc89b | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To reveal the shop owner''s conflicted feelings about the new picture"},{"id":"b","text":"To convey the shop owner''s resentment of the person he got the new picture from"},{"id":"c","text":"To describe the items that the shop owner most highly prizes"},{"id":"d","text":"To explain differences between the new picture and other pictures in the shop"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | e23f50b9 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It asserts that in medieval Europe steam baths were more popular in rural areas than in urban ones."},{"id":"b","text":"It describes a limitation of earlier historians'' studies of medieval European bathing habits."},{"id":"c","text":"It concedes that not all people in medieval Europe had access to public bathhouses."},{"id":"d","text":"It explains why Janega decided to study the popularity of public bathhouses in medieval Europe."}]'::jsonb,
  'c',
...
-- Text Structure and Purpose | 48555763 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It elaborates on the previous sentence''s description of the character."},{"id":"b","text":"It introduces the setting that is described in the sentences that follow."},{"id":"c","text":"It establishes a contrast with the description in the previous sentence."},{"id":"d","text":"It sets up the character description presented in the sentences that follow."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | e7247766 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It explains why parasites are less susceptible to horizontal gene transfer than their hosts are."},{"id":"b","text":"It clarifies why some genes are more likely to be transferred horizontally than others are."},{"id":"c","text":"It contrasts how horizontal gene transfer occurs among vertebrates with how it occurs among invertebrates."},{"id":"d","text":"It describes a means by which horizontal gene transfer might occur among vertebrates."}]'::jsonb,
  'd',
...
-- Text Structure and Purpose | ae2b3112 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To examine how Derksen''s musical compositions blend cultures"},{"id":"b","text":"To argue that Derksen should be recognized for creating a new style of music"},{"id":"c","text":"To describe the difficulties Derksen encountered when producing her album"},{"id":"d","text":"To establish a contrast between Derksen''s classical training and her Cree heritage"}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 8bc66f89 | medium
(
  'mcq',
  'rw',
...
-- Text Structure and Purpose | 6bc0ba75 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It states the hypothesis that Chang and colleagues had set out to investigate using mimosa trees and"},{"id":"b","text":"terrenus. B. It presents a generalization that is exemplified by the discussion of the mimosa trees and B. terrenus."},{"id":"c","text":"It provides context that clarifies why the species mentioned spread to new locations."},{"id":"d","text":"It offers an alternative explanation for the findings of Chang and colleagues."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | b4d29611 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"altogether. It describes a problem that arises in research on a particular topic, then sketches a historian''s approach to addressing"},{"id":"b","text":"that problem."},{"id":"c","text":"It lists the advantages of a particular research method, then acknowledges a historian''s criticism of that method. It characterizes a particular topic as especially challenging to research, then suggests a related topic for historians to"},{"id":"d","text":"pursue instead."}]'::jsonb,
  'b',
...
-- Text Structure and Purpose | f6352bd3 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It describes a common view among archaeologists, then discusses a recent finding that challenges that view."},{"id":"b","text":"It outlines a method used in some archaeological fieldwork, then explains why an alternative method is superior to it. It presents contradictory conclusions drawn by archaeologists, then evaluates a study that has apparently resolved"},{"id":"c","text":"that contradiction."},{"id":"d","text":"It identifies a gap in scientific research, then presents a strategy used by some archaeologists to remedy that gap."}]'::jsonb,
  'a',
...
-- Text Structure and Purpose | 9b01bcf4 | hard
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"It describes a direction that Cruse felt the Civil Rights Movement ought to take."},{"id":"b","text":"It indicates that Cruse''s reputation as a persistent antagonist of other scholars is undeserved."},{"id":"c","text":"It describes a controversy that Cruse''s work caused within the Black nationalist movement."},{"id":"d","text":"It helps explain Cruse''s position with respect to the community of civil rights thinkers."}]'::jsonb,
  'd',
  'Choice D is the best answer. The text as a whole claims that Cruse disagreed with virtually all other Civil Rights scholars and activists. The underlined sentence describes one way that Cruse both did and didn''t fit in with those thinkers: he criticized Black nationalists, even though he identified as one. Choice A is incorrect. The underlined sentence doesn''t do this. It describes Cruse''s criticisms-it never mentions what Cruse did want the movement to do instead. Choice B is incorrect. This conflicts with the text, which argues that Cruse did disagree with almost all other scholars of the Civil Rights Movement. Choice C is incorrect. This is a step too far. The text never says that Cruse''s work caused controversy within the Black nationalist movement.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Text Structure and Purpose | 1090b367 | medium
(
  'mcq',
  'rw',
  ...
  '[{"id":"a","text":"To describe the similarities and differences between ragtime music and opera"},{"id":"b","text":"To argue that more attention should be given to Joplin''s lesser-known works"},{"id":"c","text":"To encourage music lovers to listen to music by many different composers"},{"id":"d","text":"To explain how Joplin learned to compose and perform ragtime music"}]'::jsonb,
  'b',
...
-- Cross Text Connections | 97e5bf55 | hard
(
  'mcq',
  'rw',
...
Based on the texts, both Sykes in Text 1 and the scholars in Text 2 would most likely agree with which statement?',
  '[{"id":"a","text":"John Fletcher''s writing has a unique, readily identifiable style."},{"id":"b","text":"The women characters in John Fletcher''s plays are similar to the women characters in Philip Massinger''s plays."},{"id":"c","text":"The Two Noble Kinsmen belongs in one-volume compilations of Shakespeare''s complete plays."},{"id":"d","text":"Philip Massinger''s style in the first and last acts of The Two Noble Kinsmen is an homage to Shakespeare''s style."}]'::jsonb,
  'a',
...
-- Cross Text Connections | 02fd3da7 | easy
(
  'mcq',
  'rw',
...
Based on the texts, how would Singh and Roy (Text 2) most likely respond to the research discussed in Text 1?',
  '[{"id":"a","text":"Only countries of a certain population size should implement mandatory voting.\nPeople who are forced to vote are likely to become politically engaged in other ways, such as volunteering or running"},{"id":"b","text":"for office.\nRequiring people to vote does not necessarily lead to election outcomes that better represent the preferences of the"},{"id":"c","text":"country as a whole."},{"id":"d","text":"Countries that require voting must also make the process of voting easier for their citizens."}]'::jsonb,
  'c',
  'Choice C is the best answer. Text 1 claims that mandatory voting results in elections that "better reflect the preferences
of the country." Singh and Roy disagree. They claim that more voters doesn''t equal more quality votes--instead, they
argue that forced voting may lead to less-informed votes that "may not reflect [voters''] actual preferences."
Choice A is incorrect. Neither text mentions the population size of countries that require voting, or how that might affect
election outcomes. Choice B is incorrect. Neither text discusses the effects of mandatory voting on other forms of
political engagement. Choice D is incorrect. Neither text discusses the ease or difficulty of the voting process in
...
-- Cross Text Connections | 105ea6de | hard
(
  'mcq',
  'rw',
...
By concurring that the risk described in Text 1 should be evaluated but emphasizing that the risk is more than offset',
  '[{"id":"a","text":"by the potential benefits of nanomaterial conjugation\nBy arguing that the situation described in Text 1 may not be representative but conceding that the effects of"},{"id":"b","text":"nanomaterial conjugation are harder to predict than researchers had expected\nBy denying that the circumstance described in Text 1 is likely to occur but acknowledging that many aspects of"},{"id":"c","text":"nanomaterial conjugation are still poorly understood\nBy agreeing that the possibility described in Text 1 is a cause for concern but pointing out that nanomaterial"},{"id":"d","text":"conjugation does not inevitably produce that result"}]'::jsonb,
  'd',
...
silicon dioxide and zinc oxide together have all the benefits of zinc oxide nanoparticles without any of the DNA harm zinc
oxide has on its own.
...
conjugation vary by case." Choice B is incorrect. The author of Text 2 states that the effects of nanomaterial conjugation
"vary by case," and that the attention that their potential toxicity has drawn is warranted. If the situation in Text 1 weren''t
representative, then there would be less attention to the potential danger of these materials. Furthermore, neither
passage suggests that researchers had expected that they could predict the effects of nanomaterial conjugation. Choice
C is incorrect. The author of Text 2 agrees that the potential toxicity of nanohybrids "has drawn deserved attention," so
they aren''t denying the problem.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | c4737d6a | hard
(
  'mcq',
  'rw',
...
By pointing out that given the revised timeline for the end of the Sahara''s humid period, the Neolithic peoples'' mode',
  '[{"id":"a","text":"of subsistence likely didn''t cause the region''s desertification\nBy claiming that pastoralism was only one of many behaviors the Neolithic peoples took part in that may have"},{"id":"b","text":"contributed to the Sahara''s changing climate"},{"id":"c","text":"By insisting that pastoralism can have both beneficial and deleterious effects on a region''s vegetation and climate\nBy asserting that more research needs to be conducted into factors that likely contributed to the desertification of the"},{"id":"d","text":"Sahara region"}]'::jsonb,
  'a',
...
-- Cross Text Connections | a87c3925 | hard
(
  'mcq',
  'rw',
...
On average, the diets of people in the United States tend to have fewer foods that contain certain dipeptides than the',
  '[{"id":"a","text":"diets of people in Japan have.\nChemical compounds that activate both the umami and salty taste receptors tend to have a higher molecular weight"},{"id":"b","text":"than those that only activate umami taste receptors.\nFermentation introduces proteins responsible for the increase of umami flavor in soy sauce, and those proteins also"},{"id":"c","text":"increase the perception of saltiness.\nThe broths in the 2007 experiment most likely did not have a substantial amount of the dipeptides that played a key"},{"id":"d","text":"part in the 2022 experiment."}]'::jsonb,
  'd',
  'Choice D is the best answer. Ishii and O''Mahony were trying to isolate the pure umami flavor, while Jünger was trying to
recreate soy sauce, which has a mix of flavors that includes umami. Accordingly, the broths from Text 1 are not described
as having any soy sauce in them--just "shiitake mushrooms and kombu seaweed." So they probably don''t have as much
of the dipeptides described in Text 2, which were found to be a key part of soy sauce''s umami-ness and its saltiness.
Choice A is incorrect. Neither text supports this. Neither text gets into the diets of people in the United States, nor the
diets of people in Japan. Choice B is incorrect. Neither text supports this. Text 2 does talk about the molecular weights of
chemical compounds, but there isn''t enough information provided about molecular weights in Text 1 to make an
inference about what the scientists in Text 1 would say. Choice C is incorrect. Neither text supports this. Text 1 briefly
mentions that soy sauce is "made from fermented soybeans," but it never claims that fermentation is responsible for its
flavor in any way. And Text 2 never mentions fermentation at all.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 7bf79a90 | medium
(
  'mcq',
  'rw',
...
Most microbes are better able to survive in environments with extremely dry conditions than in environments with',
  '[{"id":"a","text":"harsh temperatures.\nA much higher number of microbes would probably be found if another sample of soil were taken from the Antarctic"},{"id":"b","text":"study site.\nMicrobes are likely difficult to detect in the soil at the Antarctic study site because they tend to be smaller than"},{"id":"c","text":"microbes found in typical soil elsewhere."},{"id":"d","text":"Most microbes are probably unable to withstand the soil conditions at the Antarctic study site."}]'::jsonb,
  'd',
  'Choice D is the best answer because it presents a statement about microbes with which Fierer''s team (Text 1) and the
author of Text 2 would most likely agree. Text 1 states that microbes usually thrive in very harsh conditions, and so
Fierer''s team was surprised when samples collected from an extremely cold and dry area of Antarctica didn''t appear to
contain any life. Fierer''s team says that though this doesn''t conclusively prove there are no microbes in the area, it
suggests that microbes would have a notably difficult time surviving in the environment. The author of Text 2 says it''s
unlikely that there would be no microbes at all in the Antarctic study site from which Fierer''s team retrieved soil samples
and that there may have been hard-to-detect microbes in the samples. However, the presence of only a few microbes in
the Antarctic samples rather than the billions found in a typical soil sample (which would presumably be much easier to
detect) would illustrate conditions in the Antarctic soil that make it difficult for microbes to thrive. Since Fierer''s team
says that the seeming absence of microbes in the Antarctic samples suggests an unusually harsh environment and the
author of Text 2 says that even if there are a few undetectable microbes in the samples, the relatively tiny number of
microbes would also suggest an unusually harsh environment, then Fierer''s team and the author of Text 2 would most
likely agree that most microbes are unable to withstand the soil conditions at the Antarctic study site.
Choice A is incorrect. The samples taken by Fierer''s team were from an area of Antarctica that is described in part as
extremely dry, and these samples didn''t appear to have any life. Therefore, even though these samples also came from
an extremely cold area, Fierer''s team wouldn''t argue based on the evidence available that microbes were better able to
survive in dry conditions than in areas with harsh temperatures. Moreover, the author of Text 2 says that microbes are
found in virtually every environment on Earth but doesn''t compare dry environments and harsh environments. Choice B is
incorrect. Nothing in Text 1 indicates that another collection of samples from the Antarctic study site might yield
different results from the samples already taken by Fierer''s team. The author of Text 2 does state that microbes are
found in virtually every environment on Earth and suggests that new technology may be better able to detect so few
microbes in a soil sample, but the author of Text 2 concludes that the unusual absence of microbes in the Antarctic
samples is evidence of the harsh Antarctic environment. Therefore, there is no reason to believe that the author of Text 2
thinks that another sample drawn from that same harsh environment would yield a much higher number of microbes.
Choice C is incorrect. The author of Text 2 does speculate that there may have been so few microbes in the Antarctic
samples that current technology couldn''t detect them, but the author doesn''t speculate that this is due to the size of the
microbes. Moreover, nothing that Fierer''s team says suggests that they are speculating that their samples might have
microbes that are smaller than microbes in typical soil samples.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | 8d802289 | easy
(
  'mcq',
  'rw',
...
Based on the texts, both authors would most likely agree with which statement?',
  '[{"id":"a","text":"Dancers who worked with Ailey greatly appreciated his supportive approach as a choreographer."},{"id":"b","text":"Ailey''s work was strongly influenced by jazz."},{"id":"c","text":"Audiences were mostly unfamiliar with the jazz music in Ailey''s works."},{"id":"d","text":"Ailey blended multiple genres of music together when choreographing dance pieces."}]'::jsonb,
  'b',
  'Choice B is the best answer. Author 1 states that Ailey had a "deep admiration for jazz music" and that he "helped bring
jazz to life for his audiences." Author 2 states that "Jazz is present throughout Ailey''s work." While the authors name
different aspects of Ailey''s work as the most influenced by jazz, they agree that jazz was a strong influence.
...
approach as a choreographer, so we have no evidence that either author would agree with this. Choice C is incorrect. This
isn''t something that either text claims. Neither text mentions how familiar audiences were with any aspect of Ailey''s
works, so we have no evidence that either author would agree with this. Choice D is incorrect. This isn''t something that
either text claims. Neither text mentions any genre of music other than jazz, so we have no evidence that either author
...
-- Cross Text Connections | 835d1ae6 | easy
(
  'mcq',
  'rw',
...
portion of Text 1?',
  '[{"id":"a","text":"Depictions of human faces are significantly more realistic than depictions of plants and other animals are.\nIt is likely that some depictions of human faces with extensive markings are intended to portray the same historical"},{"id":"b","text":"individual."},{"id":"c","text":"Some vessels may have been damaged during their excavation and thus provide little insight into Moche culture.\nMarkings on depictions of human faces are not necessarily intended to portray particular details about the physical"},{"id":"d","text":"appearance of individuals."}]'::jsonb,
  'd',
  'Choice D is the best answer. Trever thinks that the "hyper-realistic portrayal of identifiable people" interpretation ignores
the sculptors'' imagination and creativity. We can infer that Trevor thinks the facial markings on the sculptures may not
have represented real skin blemishes on real people.
Choice A is incorrect. The text gives us no reason to think that Trever would respond to the underlined interpretation in
this way. Neither text compares the depictions of human faces to the depictions of plants or animals, so we have no
basis to draw this conclusion. Choice B is incorrect. The text gives us no reason to think that Trever would respond to the
underlined interpretation in this way. There''s nothing in either text about multiple depictions representing the same
person, so we have no basis to draw this conclusion. Choice C is incorrect. The text gives us no reason to think that
Trever would respond to the underlined interpretation in this way. Neither text mentions the state of the vessels
(damaged or intact), so we have no basis to draw this conclusion.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | 81da17d3 | easy
(
  'mcq',
  'rw',
...
Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?',
  '[{"id":"a","text":"Carracci and Fontana were among the most well-respected painters in Bologna at the time."},{"id":"b","text":"The depiction of Fontana in Self-Portrait at the Keyboard was intended to underscore the artist''s creativity."},{"id":"c","text":"Fontana likely inspired the reference to an easel and palette in Carracci''s painting."},{"id":"d","text":"Self-Portrait at the Keyboard was painted earlier than Carracci''s painting and also refers to the artist''s craft."}]'::jsonb,
  'd',
  'Choice D is the best answer. The author of Text 2 states that Fontana''s painting, which depicts a painting easel in the
background, was made in 1577, eight years before Carracci''s painting. Therefore, they might argue that Caracci was not
"the first artist" to depict themself as a painter.
Choice A is incorrect. The texts don''t support this choice. Neither text mentions the reputation or status of either Carracci
or Fontana. Choice B is incorrect. The author of Text 2 does not comment on the intention or meaning of Fontana''s self-
depiction in Self-Portrait at the Keyboard. This choice also holds little connection to the underlined claim. Choice C is
incorrect. The texts don''t support this choice. The author of Text 2 does not suggest any inspirational relationship
between Fontana and Carracci. The author of Text 2 is concerned with showing that Fontana''s painting is the earliest
example of an artist referring to painting in their self-portrait, but makes no mention of her influence on others.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | d6c77ae5 | hard
(
  'mcq',
  'rw',
...
Based on the texts, how would Putirka and Xu (Text 2) most likely characterize the conclusion presented in Text 1?',
  '[{"id":"a","text":"As unexpected, because it was widely believed at the time that white dwarf exoplanets lack continental crusts\nAs premature, because researchers have only just begun trying to determine what kinds of crusts white dwarf"},{"id":"b","text":"exoplanets had\nAs questionable, because it rests on an incomplete consideration of potential sources of the elements detected in"},{"id":"c","text":"white dwarf atmospheres\nAs puzzling, because it''s unusual to successfully detect lithium and sodium when analyzing wavelengths of light in"},{"id":"d","text":"white dwarf atmospheres"}]'::jsonb,
  'c',
  'Choice C is the best answer because it reflects how Putirka and Xu (Text 2) would likely characterize the conclusion
presented in Text 1. Text 1 discusses a study by Mark Holland and colleagues in which they detected traces of lithium
and sodium in the atmospheres of four white dwarf stars. The team claims that this supports the idea that exoplanets
with continental crusts like Earth''s once orbited these stars. Text 2 introduces Putirka and Xu, who indicate that sodium
and lithium are present in several different minerals and that some of those minerals might exist in types of rock that are
not found on Earth. Therefore, Putirka and Xu would likely describe the conclusion in Text 1 as questionable because it
does not consider that lithium and sodium are also found in rocks that are not like Earth''s continental crust.
Choice A is incorrect because the texts do not indicate how widely held any of the viewpoints described are. Choice B is
incorrect because neither text discusses how new this area of study is. Choice D is incorrect because neither text
discusses how likely lithium and sodium are to be detected by analyzing wavelengths of light.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 8de51658 | medium
(
  'mcq',
  'rw',
...
It would suggest an interesting direction for future research were it not the case that two of the physicists who',
  '[{"id":"a","text":"conducted the experiment disagree on the significance of its findings.\nIt provides empirical evidence that the current understanding of an aspect of physics at a microscopic level must be"},{"id":"b","text":"incomplete."},{"id":"c","text":"It is consistent with the current understanding of physics at a microscopic level but not at a macroscopic level.\nIt supports a claim about an isolated system of atoms in a laboratory, but that claim should not be extrapolated to a"},{"id":"d","text":"general claim about the universe."}]'::jsonb,
  'b',
...
(and, maybe, turn back time!). The experiment confirmed that those processes are not reversible even on the microscopic
level, but it didn''t explain why. This supports Author 1''s point that physicists still don''t fully understand how things work at
a microscopic level--maybe the laws need to be revised.
...
-- Cross Text Connections | 059f7201 | medium
(
  'mcq',
  'rw',
  'Graphic novels are increasingly popular in bookstores and libraries, but they shouldn''t be classified as literature. By
definition, literature tells a story or conveys meaning through language only; graphic novels tell stories through
illustrations and use language only sparingly, in captions and dialogue. Graphic novels are experienced as series of
images and not as language, making them more similar to film than to literature.
Text 2
Graphic novels present their stories through both language and images. Without captions and dialogue, readers would be
unable to understand what is depicted in the illustrations: the story results from the interaction of text and image.
Moreover, Alison Bechdel''s Fun Home and many other graphic novels feature text that is as beautifully written as the
prose found in many standard novels. Therefore, graphic novels qualify as literary texts.
Based on the texts, how would the author of Text 2 most likely respond to the overall argument presented in Text 1?',
  '[{"id":"a","text":"By asserting that language plays a more important role in graphic novels than the author of Text 1 recognizes"},{"id":"b","text":"By acknowledging that the author of Text 1 has identified a flaw that is common to all graphic novels\nBy suggesting that the story lines of certain graphic novels are more difficult to understand than the author of Text 1"},{"id":"c","text":"claims"},{"id":"d","text":"By agreeing with the author of Text 1 that most graphic novels aren''t as well crafted as most literary works are"}]'::jsonb,
  'a',
  'Choice A is the best answer because it most accurately states how the author of Text 2 would most likely respond to the
argument presented in Text 1. In arguing that graphic novels shouldn''t be classified as literature and are more
comparable to film, Text 1 claims that language plays a relatively limited role in graphic novels: images, not language, are
the primary means by which graphic novels tell their stories, and language is used "only sparingly"--that is, comparatively
very little--in the form of captions and dialogue. However, the author of Text 2 asserts that language in graphic novels is
as equally vital for conveying meaning as images are, since without captions and dialogue, readers wouldn''t be able to
make sense of the narrative. Moreover, the author of Text 2 argues that there are many graphic novels that are
"beautifully written" and whose use of language is as accomplished as any standard novel. Because Text 1 argues that
language is subordinate to images in graphic novels, whereas Text 2 highlights how language is an essential component
of a graphic novel''s storytelling, it can reasonably be inferred that the author of Text 2 would say that language plays a
more important role in graphic novels than the author of Text 1 recognizes.
Choice B is incorrect. Although Text 1 indicates that graphic novels shouldn''t be classified as literature based on their
limited use of language, there''s no indication that the author of Text 1 considers this limited use of language as a flaw,
just that it doesn''t fit the particular definition of "literature" proposed in the text. Even if Text 1 had suggested that their
use of language was a common flaw of graphic novels, the author of Text 2 emphasizes how many graphic novels are
"beautifully written," and would therefore say that their use of language is exemplary, not that it is flawed. Choice C is
incorrect because Text 1 doesn''t claim that the story lines of graphic novels are generally relatively easy to understand; in
addition, Text 2 argues that given their dependence on the interaction of image and text, the stories of graphic novels
would be incomprehensible if their captions and dialogue were removed, not that the story lines of some graphic novels
are more difficult to understand than Text 1 acknowledges. Choice D is incorrect because the author of Text 1 doesn''t
imply that graphic novels aren''t well crafted, only that they use language too sparingly to fit the definition of "literature,"
and that their use of images to convey stories makes them more comparable to film than to literature. Even if the author
of Text 1 had implied that most graphic novels aren''t well crafted, Text 2 refers to the fact that many graphic novels are
as beautifully written--that is, well crafted--as many standard novels; thus, it wouldn''t be accurate to say that the author
of Text 2 would agree with the author of Text 1 that most graphic novels aren''t well crafted.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | 4b4ab04e | hard
(
  'mcq',
  'rw',
  'Mycoprotein is a fungal biomass that can be eaten as an alternative to meat. Studies of the environmental impact of its
manufacture generally agree it is lower than that of beef and closer to that of chicken or pork. But the expense of
producing mycoprotein restricts its availability to a few countries with postindustrial economies. Knowing that cost
reductions would expand access to mycoprotein, biochemists are exploring solutions, such as a cheaper substrate to
feed the mycoprotein as it grows.
Text 2
Cattle farming is a principal cause of global deforestation, and a study by Florian Humpenöder and his colleagues found
that replacing 20% of beef consumption worldwide with consumption of mycoprotein would cut deforestation by half if
...
consumption with mycoprotein consumption, an effort must be made to substitute mycoprotein for chicken and pork',
  '[{"id":"a","text":"in diets as well\nBy asserting that the development of a more inexpensive substrate for mycoprotein production would contribute to"},{"id":"b","text":"the goal of decreasing worldwide deforestation over time\nBy noting that most people would be more likely to use mycoprotein as a substitute for chicken or pork in their diets"},{"id":"c","text":"than as a substitute for beef\nBy pointing out that some countries are responsible for greater deforestation than others and thus, to have any"},{"id":"d","text":"significant effect on the environment, will have to replace more than 20% of their beef consumption with mycoprotein"}]'::jsonb,
  'b',
...
deforestation would be reduced by half over the next thirty years if 20% of the beef consumed worldwide were replaced
with mycoprotein. The author of Text 1 points out that mycoprotein is not widely available because of its high production
cost, but goes on to note that this problem could be addressed by the creation of a cheaper substrate to feed
mycoprotein. This suggests that the author of Text 1 would assert that the development of a less expensive mycoprotein
substrate would contribute to the reduction in deforestation described in the study findings discussed in Text 2: if
reducing the cost of mycoprotein increases people''s access to it, then mycoprotein may be able to replace beef in more
people''s diets, thereby reducing the deforestation associated with beef production.
Choice A is incorrect because the author of Text 1 indicates that the environmental impact of mycoprotein production is
close to that of chicken or pork production, so there is no reason to think that the author would assert that replacing
chicken or pork with mycoprotein would be environmentally beneficial: such a replacement would not lessen the total
environmental impact of food manufacture. Additionally, the specific issue of agricultural water consumption is never
mentioned in Text 1, so there is no evidence indicating what the author of Text 1 would say about that issue. Choice C is
incorrect. Although Text 1 does compare the environmental effects of producing mycoprotein to those of producing
chicken or pork, nothing in Text 1 suggests that the author believes that people are more likely to replace chicken or pork
with mycoprotein than they are to replace beef with mycoprotein. Choice D is incorrect because Text 1 makes no mention
of countries'' varying contributions to deforestation, so there is no evidence that the author of Text 1 would respond to the
finding described in Text 2 by saying that some countries will have to replace more than 20% of their beef consumption
with mycoprotein.',
  'craft-structure',
  'hard',
  0,
...
-- Cross Text Connections | ed52a093 | easy
(
  'mcq',
  'rw',
  'Flamingos are known for their vibrant pink coloring, but they''re actually born with gray feathers. Their pink color comes
from eating brine shrimp, but brine shrimp aren''t naturally pink either. Animals can''t produce carotenoids, the pigments
that provide the pink hue. The algae that brine shrimp feed on, however, can produce these pigments. Thus, the pinker the
flamingo, the more shrimp it has eaten.
Text 2
Ecologist Juan Amat has found that flamingos apply a kind of makeup to make themselves appear pinker. A gland near
their tail contains pigments that come from the food they eat. When the flamingos groom themselves using the
pigments, their feathers become pinker. Flamingos may do this to improve their success during mating season, when
...
Based on the texts, how would the ecologist in Text 2 most likely respond to the author''s conclusion in Text 1?',
  '[{"id":"a","text":"By emphasizing that flamingos'' tail feathers are pinker than their other feathers are"},{"id":"b","text":"By claiming that the coloring of flamingos'' feathers doesn''t change significantly enough for most observers to notice"},{"id":"c","text":"By pointing out that the amount of shrimp eaten isn''t the only thing that influences flamingos'' coloring"},{"id":"d","text":"By arguing that flamingos'' diet doesn''t include much shrimp except during mating season"}]'::jsonb,
  'c',
  'Choice C is the best answer because it describes how the ecologist in Text 2 would most likely respond to the author''s
conclusion in Text 1 based on the information provided. The author of Text 1 states that the pink color of flamingo
feathers comes from pigments carried by the brine shrimp flamingos consume. The author of Text 1 concludes that this
means that a flamingo that is pinker than another flamingo must have eaten more shrimp. However, according to Text 2,
ecologist Juan Amat has found that flamingos can also affect how pink they look through grooming, when they move
ingested pigments from a gland near the tail to their feathers. This indicates that not all the pigments available from the
shrimp a flamingo has eaten automatically end up coloring the flamingo''s feathers; some may or may not be applied
later. Since grooming is also a factor, the ecologist (Amat) in Text 2 would most likely respond to the conclusion in Text 1
that pinker flamingos have eaten more shrimp by pointing out that the amount of shrimp eaten isn''t the only thing that
influences flamingos'' coloring.
Choice A is incorrect. Although Text 2 states that the ecologist has found that flamingos can move pigments to their
feathers from a gland near their tail, there is no indication that their tail feathers are pinker than their other feathers.
Moreover, the point that tail feathers are pinker than other feathers wouldn''t logically address the idea that the quantity of
shrimp eaten is what determines a flamingo''s coloring. Choice B is incorrect because Text 2 indicates that the ecologist
has found that flamingos'' feathers do sometimes look pinker and gives no indication that this change in color is
particularly subtle. Moreover, the point that most observers wouldn''t notice a change wouldn''t logically address the idea
that the quantity of shrimp eaten is what determines a flamingo''s coloring. Choice D is incorrect because nothing in Text
2 suggests that the ecologist would argue about flamingos'' shrimp consumption. Although Text 2 indicates that the
ecologist has found that flamingos may make themselves look pinker during mating season, this is addressed in terms
of grooming habits; apart from referring to food as a source of pigments, Text 2 doesn''t discuss the diet of flamingos at
all.',
  'craft-structure',
  'easy',
  0,
...
-- Cross Text Connections | e1befb41 | medium
(
  'mcq',
  'rw',
...
By acknowledging that free time is more likely to enhance life satisfaction when it is spent productively than when it',
  '[{"id":"a","text":"is spent unproductively\nBy challenging the reasoning in Text 1, as it has not been proved that productivity commonly contributes to"},{"id":"b","text":"individuals'' life satisfaction\nBy warning against making an overly broad assumption, as there is no clear consensus in distinguishing between"},{"id":"c","text":"productive and unproductive activities\nBy claiming that the specific activities named in Text 1 are actually examples of productive activities rather than"},{"id":"d","text":"unproductive ones"}]'::jsonb,
  'c',
...
conclude that time spent doing tasks she defines as unproductive, such as watching TV or playing games, correlated
with a drop in life satisfaction. However, in Text 2 Maddux says that there is no objective definition of what constitutes
productive behavior, giving the example that reading a book might be considered productive by some but unproductive by
others. It can be inferred that Maddux would also assert that whether watching TV or playing games is productive or
unproductive is a matter of subjective judgment. Thus, Maddux would most likely caution against making an overly broad
assumption, as there is no clear consensus in distinguishing between productive and unproductive activities.
Choice A is incorrect because Maddux asserts that individuals have unique needs for life satisfaction: some may want to
spend that time productively, others unproductively, and what counts as productive is subjective. Therefore, Maddux
would likely not consider it universally true that free time is more likely to enhance life satisfaction when it is spent
productively. Choice B is incorrect because the study described in Text 1 concerns whether free time contributes to life
satisfaction, not whether productivity contributes to life satisfaction. The dip in life satisfaction that Sharif claims to
observe in Text 1 happens only after five hours, and mainly if the time is spent unproductively--that is, two hours of free
time spent productively might increase life satisfaction just as much as two hours spent unproductively. Choice D is
incorrect because Maddux holds the opinion that whether an activity is productive or unproductive is subjective and
depends on the individual; therefore, he would most likely claim that watching TV or playing games might be productive
for some and unproductive for others.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | c68ceeff | easy
(
  'mcq',
  'rw',
...
Based on the texts, the author of Text 1 and the author of Text 2 would most likely agree with which statement?',
  '[{"id":"a","text":"Cassava did not become a significant crop in West Africa until long after it was first introduced."},{"id":"b","text":"Several of the most commonly grown crops in West Africa are originally from Brazil."},{"id":"c","text":"The climate of the West African coast in the 1500s prevented cassava''s spread in the region."},{"id":"d","text":"The most commonly used methods to cook cassava today date to the 1500s."}]'::jsonb,
  'a',
  'Choice A is the best answer. Text 1 states that cassava''s "rise to popularity was slow" in West Africa. Text 2 also
describes cassava''s "slow adoption into the diet of West Africans." While the two texts identify different causes for this
slow adoption, both agree that cassava took a long time to catch on.
Choice B is incorrect. This isn''t something that either text claims. Cassava is the only crop discussed in the passages, so
we have no basis to draw conclusions about what the authors might say about "several" crops. Choice C is incorrect. This
isn''t something that either text claims. Neither text mentions the "climate of the West African coast," so we have no
evidence that either author would agree with this. Choice D is incorrect. This isn''t something that either text claims. The
1500s were when cassava was brought to West Africa, but neither text describes how cassava is cooked, nor do they
make any claims about when cooking methods were developed.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | f3c45b4f | hard
(
  'mcq',
  'rw',
...
Text 2
Archaeologists used new cosmogenic nuclide dating techniques to reevaluate the ages of',
  '[{"id":"a","text":"africanus fossils found in\nthe Sterkfontein Caves. This technique involves analyzing the cosmogenic nucleotides in the breccia--the matrix of rock\nfragments immediately surrounding the fossils. The researchers assert that this approach avoids the potential for\nmisdating associated with assigning ages based on Sterkfontein''s soil layers or animal bones.\nBased on the texts, how would the researchers in Text 2 most likely respond to the underlined portion in Text 1?\nThey would emphasize the fact that the A. africanus fossils found in the Sterkfontein Caves may have been corrupted\nA. in some way over the years.\nThey would contend that if analyses of surrounding layers and bones in the Sterkfontein Caves were combined, then"},{"id":"b","text":"the dating of the fossils there would be more accurate.\nThey would argue that their techniques are better suited than other methods to the unique challenges posed by the"},{"id":"c","text":"Sterkfontein Caves.\nThey would claim that cosmogenic nuclide dating is reliable in the context of the Sterkfontein Caves because it is"},{"id":"d","text":"applied to the fossils directly."}]'::jsonb,
  'c',
...
-- Cross Text Connections | f7c02e89 | hard
(
  'mcq',
  'rw',
...
By recommending that the scholars mentioned in Text 2 consider employing the methods regularly used by film and',
  '[{"id":"a","text":"television researchers\nBy pointing out that credits have a different intended purpose in film and television than in the medium addressed by"},{"id":"b","text":"the scholars mentioned in Text 2\nBy suggesting that the scholars mentioned in Text 2 rely more heavily on credits as a source of information than film"},{"id":"c","text":"and television researchers do\nBy observing that a widespread practice in film and television largely prevents the kind of problem faced by the"},{"id":"d","text":"scholars mentioned in Text 2"}]'::jsonb,
  'd',
...
information provided. Text 2 discusses how the inconsistent use of credits to identify the contributors to video games
can pose an obstacle to scholars of the medium, who rely on such credits to answer questions about the medium''s
development. Text 1 notes that in film and television, on the other hand, credits are used consistently and are valuable to
researchers studying the cast and crew members in these mediums. Since Text 1 asserts how the consistent use of
credits benefits scholars of film and television, it can be inferred that this text''s author would respond to the discussion in
Text 2 by observing that the kind of problem faced by scholars of video games--the inability to know who contributed to
a particular production and how--is, in film and television studies, largely prevented by the widespread practice of credits
in these mediums.
...
-- Cross Text Connections | 82c05b34 | medium
(
  'mcq',
  'rw',
...
Consumers are more interested in paying subscription fees to stream music than in attending music festivals in',
  '[{"id":"a","text":"person."},{"id":"b","text":"Consumers'' growing interest in purchasing experiences is mostly confined to the music industry."},{"id":"c","text":"Changing consumer behaviors are leading to changes in music-related businesses."},{"id":"d","text":"The rising consumer demand for live music festivals also generates higher demand for music streaming platforms."}]'::jsonb,
  'c',
  'Choice C is the best answer. Both authors mention how consumer behaviors have shifted, and how this affects different
aspects of the music industry. Text 1 states that consumers enjoy purchasing "lived experiences," and that this
influences how organizers design music festivals. Text 2 states that consumers are using streaming services more, and
that this reduces album sales and increases the importance of live performances for musicians.
...
-- Cross Text Connections | 5a4b147c | easy
(
  'mcq',
  'rw',
...
Based on the texts, both authors would most likely agree with which statement?',
  '[{"id":"a","text":"Sybil Ludington was crucial to the outcome of the Revolutionary War."},{"id":"b","text":"Historians have confirmed which route Sybil Ludington took."},{"id":"c","text":"Sybil Ludington was likely not a real person."},{"id":"d","text":"Many people have come to admire the story of Sybil Ludington''s ride."}]'::jsonb,
  'd',
  'Choice D is the best answer. Both authors agree that Ludington''s story has been widely celebrated and revered by
Americans, even if they disagree on its accuracy. Text 1 states that Ludington has inspired postage stamps, statues, and
TV series, and Text 2 states that many articles and books have been written about her. Thus, both authors acknowledge
the popularity of Ludington''s story.
Choice A is incorrect. Neither author claims that Ludington had a significant impact on the war. Text 1 doesn''t mention
how Ludington''s ride affected the war overall, and Text 2 suggests that Ludington''s ride may have been exaggerated or
invented over time. Choice B is incorrect. Neither author claims that Ludington''s route has been verified by historians.
Text 1 claims she rode 40 miles through Putnam County, but doesn''t cite any sources for this information, while Text 2
suggests the ride may not have even happened. Choice C is incorrect. This choice misreads text 2. Neither author claims
that Ludington was not a real person, only that her ride may not have happened. Both authors seem to treat Ludington as
...
-- Cross Text Connections | 84dbd633 | hard
(
  'mcq',
  'rw',
...
1?',
  '[{"id":"a","text":"By agreeing that the Chicxulub impact changed the climate and that the Deccan Traps eruption caused the K-Pg event\nBy declaring that the changes in climate caused by the Deccan Traps eruption weren''t the main cause of the K-Pg"},{"id":"b","text":"event"},{"id":"c","text":"By questioning why those scientists assume that the Chicxulub impact caused the Deccan Traps eruption\nBy asserting that the Deccan Traps eruption had a more significant effect on global conditions than those scientists"},{"id":"d","text":"claim"}]'::jsonb,
  'b',
  'Choice B is the best answer because it describes how Hull''s team would most likely respond to the argument in the
underlined portion of Text 1, which asserts that volcanic activity in the Deccan Traps range led to changes in the climate
and caused the K-Pg mass extinction event. According to Text 2, although Hull''s team found that activity in the Deccan
Traps did indeed alter the climate before the K-Pg event, the team determined that the climate had returned to normal
before mass extinctions began. This finding and the observation that the K-Pg extinctions closely align with the
Chicxulub asteroid impact suggest that Hull''s team would likely dispute the claim in the underlined portion of Text 1 and
say that the climate changes caused by the Deccan Traps activity were not the main cause of the extinctions.
Choice A is incorrect because Text 2 describes how Hull''s team found that the climate had recovered from the changes
brought about by the Deccan Traps activity before the K-Pg event occurred, which suggests that Hull''s team would
disagree that the Deccan Traps activity caused the K-Pg event. Additionally, the claim in the underlined portion of Text 1
says nothing about how the Chicxulub impact changed the climate, so while Hull''s team might believe that the impact did
in fact change the climate, they could not be said to agree with the claim in Text 1 on this point. Choice C is incorrect
because there is no indication in either text that any scientists assume that the Chicxulub impact caused the Deccan
Traps activity, so there is no reason to conclude that Hull''s team would question why the scientists referred to in Text 1
make such an assumption. Choice D is incorrect because Text 2 describes how Hull''s team found that the climate had
recovered from the changes brought about by the Deccan Traps activity before the K-Pg event occurred, which suggests
that Hull''s team would say that the Deccan Traps activity had a less enduring effect on global conditions than the
scientists referenced in Text 1 believe, not that the effect on global conditions was more significant than those scientists
claim.',
  'craft-structure',
  'hard',
  0,
...
-- Cross Text Connections | 9645f55e | easy
(
  'mcq',
  'rw',
...
in Text 1?',
  '[{"id":"a","text":"As inconsistent, since bluegrass purists themselves enjoy other musical genres"},{"id":"b","text":"As unrealistic, since bluegrass purists have no way of enforcing their musical preferences"},{"id":"c","text":"As shortsighted, because bluegrass could enlarge its audience by including influences from mainstream genres"},{"id":"d","text":"As illogical, because the purists overlook crucial aspects of how the bluegrass sound first originated."}]'::jsonb,
  'd',
...
Choice A is incorrect. There''s nothing in Text 2 about what other genres the purists enjoy, so this inference about Author
2''s views isn''t supported. Choice B is incorrect. There''s nothing in Text 2 about whether or how purists can enforce their
preferences, so this inference about Author 2''s views isn''t supported. Choice C is incorrect. There''s nothing in Text 2
about the size of bluegrass''s audience, so this inference about Author 2''s views isn''t supported.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | f1c9d2c1 | medium
(
  'mcq',
  'rw',
...
expertise made by Bremner in Text 1?',
  '[{"id":"a","text":"Many lighting technicians dismissed Appia''s ideas about light on the stage."},{"id":"b","text":"Appia likely gained a level of technical expertise during his time as an apprentice."},{"id":"c","text":"Theater practitioners who worked with Appia greatly admired his work."},{"id":"d","text":"Appia was unfamiliar with the use of music and sound in theater."}]'::jsonb,
  'b',
...
apprentice would have, the author of Text 2 argues, allowed Appia to "[develop] his understanding of what was possible"
with the elements of theatrical design.
...
anything about Appia''s familiarity with or ignorance of the use of music and sound in theater. Both focus on his expertise
(or lack thereof) in lighting.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | dc043599 | easy
(
  'mcq',
  'rw',
...
formation of the moon?',
  '[{"id":"a","text":"The author of Text 1 argues that the formation of the moon occurred much earlier than the author of Text 2 argues.\nThe author of Text 1 suggests there is more evidence confirming the existence of Theia than the author of Text 2"},{"id":"b","text":"suggests.\nThe author of Text 1 claims that the moon''s surface is more similar to Earth''s surface than the author of Text 2"},{"id":"c","text":"claims."},{"id":"d","text":"The author of Text 1 believes that the moon formed more slowly than the author of Text 2 believes."}]'::jsonb,
  'd',
...
Choice A is incorrect. While Text 2 suggests that the moon formed over "just a few hours" and Text 1 says it took
"thousands of years," neither one mentions when that formation occurred. Choice B is incorrect. While Theia isn''t
mentioned in Text 2, neither text describes or disputes evidence of Theia''s existence. Choice C is incorrect. Neither text
makes any claims about the similarity or difference between the moon''s surface and Earth''s surface.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | eae66bf9 | medium
(
  'mcq',
  'rw',
...
Based on the texts, how would Artemieva likely respond to Siraj''s hypothesis, as presented in Text 1?',
  '[{"id":"a","text":"By insisting that it overestimates how representative Wild 2 is of long-period comets as a class\nBy arguing that it does not account for the amount of iridium found in geological layers dating to the Chicxulub"},{"id":"b","text":"impact"},{"id":"c","text":"By praising it for connecting the composition of Chicxulub crater samples to the composition of certain asteroids\nBy concurring that carbonaceous chondrites are prevalent in soil samples from sites distant from the Chicxulub"},{"id":"d","text":"crater"}]'::jsonb,
  'b',
...
Artemieva would respond to Siraj''s hypothesis. "Soil samples from sites distant from the Chicxulub crater" is too vague.
Only soil samples from sites that are connected to the impact in some way are involved in either hypothesis.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | 3080769 | medium
(
  'mcq',
  'rw',
...
By agreeing with those proponents that Moore''s treatment of positions that contradict his own is fundamentally',
  '[{"id":"a","text":"unserious\nBy suggesting that an instinctive distaste for Moore''s position is preventing external world skeptics from constructing"},{"id":"b","text":"a sufficiently rigorous refutation of Moore\nBy arguing that if it is valid to assert that some facts are true based on instinct, it is also valid to assert that some"},{"id":"c","text":"proofs are inadequate based on instinct\nBy pointing out that Moore would assert that external world skepticism is at odds with other beliefs those proponents"},{"id":"d","text":"must unavoidably hold"}]'::jsonb,
  'd',
...
let alone why they have a hard time refuting Moore''s position. Choice C is incorrect. We can''t infer that the author of Text
1 would respond this way to external world skeptics. Text 1''s presentation of Moore''s concept of common sense only
includes the idea that some facts are true based on instinct--it doesn''t mention the idea that some proofs are inadequate
based on instinct.',
  'craft-structure',
  'medium',
  0,
...
-- Cross Text Connections | e4e2aeb3 | hard
(
  'mcq',
  'rw',
...
As failing to consider Ellison''s and Morrison''s equivalent uses of the sermon within the wider cultural context in which',
  '[{"id":"a","text":"they wrote"},{"id":"b","text":"As misunderstanding the function of sermons in novels by Black American writers other than Ellison and Morrison"},{"id":"c","text":"As disregarding points of structural and stylistic divergence between the works of Ellison and those of Morrison\nAs being indebted to the tradition of resisting literary conventions that privilege written forms, such as novels, over"},{"id":"d","text":"sermons and other oral forms"}]'::jsonb,
  'a',
...
Choice B is incorrect. Neither text specifically mentions sermons in works by authors other than Morrison or Ellison, only
a tendency towards eroding "the division between oral and written forms" among Black American writers. Choice C is
incorrect. Both texts describe similarities between the works of Ellison and Morrison, and neither points out instances of
divergence. Text 2 simply suggests that Morrison was influenced by more than just Ellison. Choice D is incorrect. While
Text 2 does discuss Morrison''s resistance to certain literary conventions, it''s unclear what it would mean for the
underlined claim to be "indebted" to that tradition. This choice recycles language from the text, but not in a way that
makes any coherent point.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 6a1dc7c5 | hard
(
  'mcq',
  'rw',
...
By conceding that Woolf''s talents were best suited to serious novels but asserting that the humor in Orlando is often',
  '[{"id":"a","text":"effective\nBy agreeing that Orlando is less impressive than certain other novels by Woolf but arguing that it should still be"},{"id":"b","text":"regarded as a classic\nBy acknowledging that Orlando clearly differs from Woolf''s other major novels but insisting on its centrality to her"},{"id":"c","text":"body of work nonetheless\nBy concurring that the reputation of Orlando as a minor work has led readers to overlook this novel but maintaining"},{"id":"d","text":"that the reputation is unearned"}]'::jsonb,
  'c',
  'Choice C is the best answer because it reflects how the author of Text 2 would most likely respond to the assessment of
Orlando in Text 1. Both authors agree that Orlando is unusual for Woolf: Text 1 states that the novel examines its
characters'' psychologies more superficially than Woolf''s other novels do, and Text 2 describes it as being lighter in tone.
However, while Text 1 calls Orlando an "oddity" and mentions that Woolf "began it as a joke," Text 2 asserts that Orlando
engages the same themes as Woolf''s other great novels. Hence, the author of Text 2 would most likely accept that
Orlando differs from Woolf''s other novels but would also insist on its importance in the context of Woolf''s work as a
writer.
...
compares Orlando favorably to other novels by Woolf that are implied to be darker in tone. Choice B is incorrect because
the author of Text 2 does not indicate that Orlando is less impressive than Woolf''s other novels, but instead points out
that it engages the same themes as other novels by Woolf that are considered classics. Choice D is incorrect because
there''s nothing in Text 1 or Text 2 to suggest that readers have generally ignored Orlando because of its reputation.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 5e101c70 | hard
(
  'mcq',
  'rw',
...
It is reasonable given that Srivastava and her team have identified how EGR functions in both humans and panther',
  '[{"id":"a","text":"worms."},{"id":"b","text":"It is overly optimistic given additional observations from Srivastava and her team."},{"id":"c","text":"It is unexpected given that Srivastava and her team''s findings were generally met with enthusiasm."},{"id":"d","text":"It is unfairly dismissive given the progress that Srivastava and her team have reported."}]'::jsonb,
  'b',
...
regeneration. The author of Text 2, on the other hand, focuses on the fact that the team that reported the EGR finding
pointed out that while EGR''s function in humans isn''t yet known, it''s likely very different from its function in panther
worms. Therefore, the author of Text 2 would most likely say that Text 1''s enthusiasm about the EGR discovery is overly
optimistic given Srivastava''s team''s observations about EGR in humans.
Choice A is incorrect because the author of Text 2 explains that Srivastava and her team explicitly reported that they
haven''t yet identified how EGR functions in humans; therefore, the author of Text 2 wouldn''t say that Text 1''s excitement
is reasonable for the stated reason. Instead, the author of Text 2 would likely characterize Text 1''s excitement as
premature and overly optimistic. Choice C is incorrect because Text 1 does treat Srivastava''s team''s findings with
enthusiasm; it describes the discovery of EGR in both three-banded panther worms and humans as promising and
exciting. It would be illogical for the author of Text 2 to say that because most others treat the discovery with
enthusiasm, Text 1''s enthusiastic characterization of the discovery is unexpected. Choice D is incorrect because Text 1
isn''t at all dismissive of Srivastava''s team''s findings; instead, Text 1 is optimistic about the EGR discovery, characterizing
it as promising and exciting. There''s nothing in Text 2 to suggest that the author of Text 2 would say that Text 1''s praise
for the discovery is dismissive, or disdainful.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 12d81fc1 | medium
(
  'mcq',
  'rw',
...
Based on the texts, how would the author of Text 2 most likely characterize Lacadena''s theory, as described in Text 1?',
  '[{"id":"a","text":"By praising the theory for recognizing that the script''s symbols could represent entire words"},{"id":"b","text":"By arguing that the theory is overly influenced by the work of earlier scholars"},{"id":"c","text":"By approving of the theory''s emphasis on how the script changed over time"},{"id":"d","text":"By cautioning that the theory overlooks certain important aspects of how the script functioned"}]'::jsonb,
  'd',
...
would likely consider Lacadena''s theory too simplistic: it''s missing the importance of the context in determining the
meaning of a symbol.
Choice A is incorrect. This conflicts with Text 1''s description of Lacadena''s theory. Lacadena''s theory is that Nahuatl
script symbols signified syllables. Choice B is incorrect. This conflicts with Text 1''s description of Lacadena''s theory. Text
1 states that Lacadena''s theory differed from what earlier scholars believed. Choice C is incorrect. We can''t infer that this
is how the author of Text 2 would characterize Lacadena''s theory. Neither text mentions how or even if the script
changed over time.',
  'craft-structure',
  'medium',
  0,
...
-- Cross Text Connections | 2c50ed1a | easy
(
  'mcq',
  'rw',
...
While the author of Text 1 believes that thinking about Soyinka''s works of theater in phases is useful, the author of',
  '[{"id":"a","text":"Text 2 views such an approach as limiting.\nAlthough the author of Text 1 claims that Soyinka''s style as a dramatist has evolved over time, the author of Text 2"},{"id":"b","text":"argues that Soyinka''s style has remained consistent throughout his career.\nThe author of Text 1 considers Soyinka''s plays to showcase his strongest writing, whereas the author of Text 2"},{"id":"c","text":"believes that Soyinka''s poetry is where he is most skilled.\nThe author of Text 1 argues that Soyinka''s early plays were his most politically charged, whereas the author of Text 2"},{"id":"d","text":"claims that Soyinka''s most recent plays are the most politicized."}]'::jsonb,
  'a',
  'Choice A is the best answer. The author of Text 1 states that Soyinka''s progression as a playwright can be considered to
fall into three periods, implying that this is a helpful way to understand his works. The author of Text 2, on the other hand,
challenges this view and says that it overlooks potential commonalities and differences in Soyinka''s work across what
Text 1 calls distinctive stylistic phases.
Choice B is incorrect. This choice overstates the central claim of Text 2. The author of Text 2 argues against the
chronological progression supported in Text 1, but does not go so far as to say that Soyinka''s style remained consistent.
In fact, Text 2 points out "significant differences in styles and content" among Soyinka''s plays. Choice C is incorrect.
Neither of the texts mention Soyinka''s poetry, nor do they rank his dramatic writing relative to his other work. Choice D is
incorrect. Neither text discusses the political aspects of Soyinka''s plays, nor do they make any claims about whether they
...
-- Cross Text Connections | 17bf10de | hard
(
  'mcq',
  'rw',
...
The author of Text 1 argues that Tuchman should have relied more on the work of other historians, while the author of',
  '[{"id":"a","text":"Text 2 implies that Tuchman''s most interesting claims result from her original research.\nThe author of Text 1 believes that the scope of Tuchman''s research led her to an incorrect interpretation, while the"},{"id":"b","text":"author of Text 2 believes that Tuchman''s central argument is overly simplistic.\nThe author of Text 1 asserts that the writing style of The Guns of August makes it worthwhile to read despite any\nperceived deficiency in Tuchman''s research, while the author of Text 2 focuses exclusively on the weakness of"},{"id":"c","text":"Tuchman''s interpretation of events.\nThe author of Text 1 claims that Tuchman would agree that World War I was largely due to events in Eastern Europe,\nwhile the author of Text 2 maintains that Tuchman would say that Eastern European leaders were not committed to"},{"id":"d","text":"military plans in the same way that other leaders were."}]'::jsonb,
  'b',
...
and the author of Text 2 argues that Tuchman''s main thesis is "reductive," which is a close synonym for "overly simplistic."
...
-- Cross Text Connections | d0198544 | hard
(
  'mcq',
  'rw',
...
By broadly agreeing with the claim but objecting that the timeline it presupposes conflicts with the findings of the',
  '[{"id":"a","text":"genetic analysis conducted by Storey''s team\nBy faulting the claim for implying that domestic animals couldn''t have been transferred from South America to the"},{"id":"b","text":"Polynesian Islands as well\nBy critiquing the claim for being based on an assumption that before the European invasion of South America, the"},{"id":"c","text":"chickens of Europe were genetically uniform\nBy noting that while the claim is persuasive, the findings of Luzuriaga-Neira''s team provide stronger evidence for it"},{"id":"d","text":"than the findings of the genetic analysis conducted by Storey do"}]'::jsonb,
  'd',
  'Choice D is the best answer because it accurately describes how the author of Text 2 would most likely respond to the
underlined claim in Text 1. Text 1 indicates that Storey found a genetic mutation in South American chickens from before
the European invasion and in Polynesian chickens, which implies that chickens were first brought to South America by
...
Neira and colleagues found multiple genetic markers shared by South American and Polynesian chickens but "that
European breeds lack," which strongly suggests a Polynesian origin for the South American chickens. This indicates that
the author of Text 2 believes Luzuriaga-Neira''s evidence for a Polynesian origin is compelling while Storey''s evidence has
been undermined. Thus, the author of Text 2 would most likely agree with the underlined statement and believes
Luzuriaga-Neira and colleagues'' evidence for the statement is stronger than Storey''s evidence is.
...
invaded the region" and concludes that these chickens were likely brought to South America by Polynesians. While Text 2
is not as explicit about the time period as Text 1 is, nothing in Text 2 undermines the timing of events ascribed to Storey''s
account in Text 1. Choice B is incorrect because both texts agree that chickens were first brought to South America by
Polynesian peoples (the underlined claim), and nothing in Text 2 suggests that this claim is in any way deficient because
the possibility that animals could have been transferred from South America to Polynesia was not explicitly addressed.
Choice C is incorrect because the criticism that Text 2 raises about the ideas in Text 1 is specifically about whether the
single genetic mutation cited by Storey in fact supports the idea of a Polynesian origin for South American chickens.
There is nothing in Text 2 to suggest that the underlined sentence (Storey''s conclusion) is deficient because it is based
on an assumption about the genetic uniformity of European chickens.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | ab56a107 | medium
(
  'mcq',
  'rw',
...
Based on the texts, how would the author of Text 2 most likely respond to the claims of the author of Text 1?',
  '[{"id":"a","text":"By arguing that a piece of art created digitally can still be displayed traditionally"},{"id":"b","text":"By explaining that it''s actually much harder to use a tablet and stylus to create art than to use paint and a brush"},{"id":"c","text":"By insisting that digital art requires artistic abilities and skill even if it employs less traditional tools"},{"id":"d","text":"By admitting that most digital artists don''t think fundamental drawing skills are important"}]'::jsonb,
  'c',
...
address skills needed to produce digital art. Text 1 claims that digital art doesn''t require the same amount of skill as
creating physical art and that "the technology is doing most of the work." Text 2 states that digital art requires "knowing
the fundamentals of art" and that many digital artists begin their work on paper and then transfer it to a digital format
using "sophisticated software" and "a variety of colors and techniques." Therefore, the author of Text 2 would most likely
insist that digital art requires artistic abilities even if it employs less traditional tools.
Choice A is incorrect because neither text discusses nondigital means of displaying art. Choice B is incorrect because
the author of Text 2 doesn''t address whether it''s harder to use a tablet and stylus than it is to use paint and a brush. Text
2 does argue that digital art requires skills that aren''t part of the traditional methods for producing art, but the text
doesn''t address relative difficulty. Choice D is incorrect because the author of Text 2 states that digital artists still need to
know "the fundamentals of art" and that many digital artists begin their work by drafting on paper before transferring the
...
-- Cross Text Connections | f653b273 | medium
(
  'mcq',
  'rw',
...
It is understandable because the fossil does look like it could be related to birds, even though O. khaungraae is',
  '[{"id":"a","text":"probably a lizard."},{"id":"b","text":"It is confusing because it isn''t clear what caused the researchers to think that O. khaungraae might be related to birds."},{"id":"c","text":"It is flawed because the researchers mistakenly assumed that O. khaungraae must be a lizard.\nIt is reasonable because the O. khaungraae skull is about the same size as the skull of the second fossil but is shaped"},{"id":"d","text":"differently."}]'::jsonb,
  'a',
  'Choice A is the best answer because it reflects what the paleontologists in Text 2 would most likely say about what the
researchers in Text 1 initially thought. Text 1 focuses on the discovery of a strange fossil consisting of the skull of the
extinct species Oculudentavis khaungraae. According to Text 1, the fossil has features that appear to be avian, or related
to birds, which led researchers to initially think that the fossil might be a very small avian dinosaur. Text 2 begins by
noting the discovery of a second fossil similar to the one discussed in Text 1, then explains that based on detailed
studies of both fossils, paleontologists think that the two creatures were probably unusual lizards, even though the skulls
appeared avian at first. This suggests that the paleontologists in Text 2 recognize that the fossils do indeed look like they
could be related to birds. For this reason, the paleontologists in Text 2 would most likely say that the initial thought of the
researchers in Text 1--that the fossil was avian--is understandable, even if the fossil is probably not avian but rather is
from a lizard.
Choice B is incorrect because Text 2 indicates that the fossils initially looked avian, so the paleontologists described in
Text 2 wouldn''t be confused by the researchers in Text 1 initially thinking that O. khaungraae might be related to birds.
The paleontologists would find that initial thought understandable, not confusing. Choice C is incorrect because Text 1
never mentions lizards, so it wouldn''t make sense for the paleontologists in Text 2 to say that the researchers in Text 1
mistakenly assumed that O. khaungraae must be a lizard. Choice D is incorrect. Although the paleontologists in Text 2
might agree that the initial thought of the researchers in Text 1 was reasonable, nothing in Text 2 suggests that the two
skulls were shaped differently.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | faee8ec7 | medium
(
  'mcq',
  'rw',
  'It seems clear that emotional contagion (the unintentional transfer of an emotional state from one person to another)
requires physical interaction and the observation of body language. After all, research shows that talking to someone
who is smiling and expressing positive feelings often causes people to respond in a comparably positive way. Similarly,
displays of nervous fidgeting have been found to prompt others to begin behaving more nervously, too.
Text 2
In an experiment using a social networking service, Zeyao Yang and Emilio Ferrara found evidence of emotional
contagion in text-based online interactions. The researchers discovered that reading social media posts that expressed a
positive outlook led people to make more positive posts themselves, while posts with a negative emotional tone led
people to make more negative posts.
...
It perpetuates a flawed understanding of emotional contagion, because there isn''t enough evidence to suggest that',
  '[{"id":"a","text":"smiling is a sign of emotional contagion.\nIt reflects an incomplete view of emotional contagion, because this phenomenon can occur even without in-person"},{"id":"b","text":"interaction.\nIt''s fairly persuasive, because studies attempting to identify emotional contagion in situations without in-person"},{"id":"c","text":"interaction have thus far yielded unclear results.\nIt''s mostly accurate, because the social networking study confirmed that emotional contagion primarily occurs in"},{"id":"d","text":"response to negative emotions like nervousness."}]'::jsonb,
  'b',
  'Choice B is the best answer because it represents how the researchers in Text 2 would most likely respond to the
underlined claim in Text 1. Text 1 begins by asserting that the unintended transfer of feelings from one person to another,
known as emotional contagion, seems to rely on both people being physically present and able to observe body
language. Text 1 then references research that supports this assertion. Text 2 describes an experiment conducted by the
researchers Yang and Ferrara in which they found evidence of emotional contagion in the absence of physical interaction,
namely through text-based interactions on social media. The researchers in Text 2 wouldn''t completely agree with what
is asserted in the underlined portion of Text 1 (that emotional contagion seems to require physical proximity), because
their study, which used a social media networking service, found that physical interaction isn''t the only way that
emotional contagion can take place. Thus, the researchers in Text 2 would most likely respond to the underlined claim in
Text 1 by stating that it reflects an incomplete view of emotional contagion, because the phenomenon can occur without
...
researchers thought about smiling as a sign of emotional contagion. Choice C is incorrect because the researchers in
Text 2 wouldn''t say that the underlined claim in Text 1 is fairly persuasive. According to Text 2, the researchers conducted
a study that found emotional contagion didn''t require physical interaction, because they found evidence of it in text-
based online interactions. Choice D is incorrect because neither of the texts claim that emotional contagion primarily
occurs when a person is exposed to negativity. Instead, Text 1 claims that physical interaction is required for emotional
contagion to occur, and Text 2 describes a study that suggests emotional contagion can occur in text-based online
interactions.',
  'craft-structure',
  'medium',
  0,
...
-- Cross Text Connections | 22105871 | easy
(
  'mcq',
  'rw',
...
Based on the texts, how would the author of Text 2 most likely respond to the underlined portion of Text 1?',
  '[{"id":"a","text":"By objecting that the bees were actually experiencing a negative feeling akin to stress rather than a positive feeling"},{"id":"b","text":"By arguing that some insects other than bumblebees may be capable of experiencing complex emotional states"},{"id":"c","text":"By pointing out that even humans sometimes struggle to have fun while engaging in play\nBy noting that if the bees were truly playing, any positive feelings they may have experienced were probably quite"},{"id":"d","text":"basic"}]'::jsonb,
  'd',
  'Choice D is the best answer. The author of Text 2 agrees with the author of Text 1 that bumblebees may engage in play
and possibly experience some kind of positive emotional state. However, the author of Text 2 also qualifies this claim by
stating that emotions in insects, if they do exist, are "likely very rudimentary."
Choice A is incorrect. While Text 2 states that other studies might indicate "negative emotional states" in bees, it does
not contradict the findings from the Galpayage study--that the bees might have been having fun. Choice B is incorrect.
The author of Text 2 does not mention or imply that any insects, including bumblebees, are capable of experiencing
complex emotional states. The author of Text 2 states that if insects do feel emotions, those emotions are "likely very
rudimentary." Choice C is incorrect. The author of Text 2 does not compare or contrast the behavior or emotions of
insects and humans, and neither does the author of Text 1.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | 27d9bb69 | medium
(
  'mcq',
  'rw',
...
Text 1?',
  '[{"id":"a","text":"By suggesting that curiosity may not be exclusively motivated by the desire to merely acquire information\nBy conceding that people may seek out information that serves no immediate purpose only because they think they"},{"id":"b","text":"can use it later\nBy pointing out that it is challenging to determine when information-seeking serves no goal beyond acquiring"},{"id":"c","text":"information"},{"id":"d","text":"By disputing the idea that curiosity can help explain apparently purposeless information-seeking behaviors"}]'::jsonb,
  'a',
...
Choice B is incorrect. The consensus view in Text 1 is that people acquire information regardless of whether they think
they can use it later. Dubey and colleagues acknowledge this fact (so they don''t claim people seek out information "only"
because it might be useful later). Choice C is incorrect. This choice misreads the results of Dubey and colleagues'' study
in Text 2. Neither text discusses the difficulty of determining the motivation for information-seeking. Choice D is
incorrect. This choice contradicts Text 2, which starts with Dubey and colleagues "acknowledging that acquiring
information is a powerful motivator" (i.e., agreeing that curiosity explains the seeking of apparently purposeless
information). The research in Text 2 simply suggests that more than just curiosity can motivate information-seeking
behavior when the information has a purpose.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | c885c38b | hard
(
  'mcq',
  'rw',
...
By conceding the importance of hierarchical systems but asserting the greater significance of decentralized',
  '[{"id":"a","text":"collective societies\nBy disputing the idea that developments in social structures have followed a linear progression through distinct"},{"id":"b","text":"stages"},{"id":"c","text":"By acknowledging that hierarchical roles likely weren''t a part of social systems before the rise of agriculture"},{"id":"d","text":"By challenging the assumption that groupings of hunter-gatherers were among the earliest forms of social structure"}]'::jsonb,
  'b',
  'Choice B is the best answer because it describes the most likely way that Graeber and Wengrow (Text 2) would respond
to the "conventional wisdom" presented in Text 1. According to Text 1, the conventional wisdom about human social
systems is that they developed through stages, beginning with hunter-gatherer bands, then moving to clan associations,
then chiefdoms, and finally arriving at states with bureaucratic structures. Text 2 indicates that Graeber and Wengrow
believe that human social systems have been flexible, shifting between different types of structures, including both
hierarchical and collective systems, and that these shifts may have even occurred seasonally. This suggests that Graeber
and Wengrow would dispute the idea that developments in social structures have followed a linear progression through
distinct stages.
...
others. Choice C is incorrect because Text 2 doesn''t include any information suggesting that Graeber and Wengrow
believe that hierarchies didn''t emerge until after the rise of agriculture. In fact, Text 2 indicates that Graeber and Wengrow
cite evidence suggesting that some hunter-gatherer groups formed social structures with hierarchical elements
("communities that included esteemed individuals") 50,000 years ago, long before the rise of agriculture, which Text 1
says occurred around 12,000 years ago. Choice D is incorrect because there''s no information in Text 2 suggesting that
Graeber and Wengrow would challenge the assumption that groupings of hunter-gatherers were among the earliest
forms of social structure. Although Text 1 does indicate that hunter-gatherer groups are assumed to be the earliest
human social system, Text 2 says only that Graeber and Wengrow believe that some hunter-gatherer groups made use of
different social structures at different times. Text 2 doesn''t imply that Graeber and Wengrow doubt that hunter-gatherer
groups preceded most other social structures.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | de2c2f57 | hard
(
  'mcq',
  'rw',
...
Text 1 discusses two approaches to studying mammoth extinction without advocating for either, whereas Text 2',
  '[{"id":"a","text":"advocates for one approach over the other.\nText 1 presents findings by Wang and colleagues and gives another research team''s attempt to explain those"},{"id":"b","text":"findings, whereas Text 2 provides additional detail that calls that explanation into question.\nText 1 describes Wang and colleagues'' study and a critique of their methodology, whereas Text 2 offers additional"},{"id":"c","text":"details showing that methodology to be sound.\nText 1 argues that new research has undermined the standard view of when mammoths went extinct, whereas Text 2"},{"id":"d","text":"suggests a way to reconcile the standard view with that new research."}]'::jsonb,
  'b',
...
-- Cross Text Connections | 159ef46d | easy
(
  'mcq',
  'rw',
...
sentence in Text 2?',
  '[{"id":"a","text":"As typical, because scholars are dismissive of literary works that achieve popularity with the general public\nAs unsurprising, because scholars tend to overlook the literary value of food writing in general and of regional"},{"id":"b","text":"cookbooks in particular\nAs justifiable, because Lewis incorporated memoir into The Taste of Country Cooking, thus undermining its status as"},{"id":"c","text":"a cookbook\nAs inevitable, because The Taste of Country Cooking was marketed to readers of food writing and not to readers of"},{"id":"d","text":"other genres"}]'::jsonb,
  'b',
  'Choice B is the best answer. Text 1 states that literary scholars ignore regional cookbooks most of all, even when they
have historical significance and are well written. So the author of Text 1 wouldn''t be surprised that scholars ignored Edna
Lewis''s cookbook.
...
that scholars are dismissive of popular works in general. Instead, Text 1 says that scholars ignore food writing
specifically, despite its popularity--and despite the fact that it can be historically significant and complex. Choice C is
incorrect. We can''t infer that this is how the author of Text 1 would regard the situation. Text 1 never suggests that
elements of other genres should be kept out of cookbooks. Choice D is incorrect. We can''t infer that this is how the
author of Text 1 would regard the situation. Text 1 never discusses how food writing is or should be marketed.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | c106b9f7 | easy
(
  'mcq',
  'rw',
...
Based on the texts, both authors would most likely agree with which statement?',
  '[{"id":"a","text":"Lewis''s portrait busts have overshadowed her other work."},{"id":"b","text":"The Death of Cleopatra is Lewis''s most famous piece."},{"id":"c","text":"Sculpting representations of historical figures was a short-lived trend."},{"id":"d","text":"Lewis''s works are varied in the subjects they depict."}]'::jsonb,
  'd',
...
Choice A is incorrect. Neither text suggests that Lewis''s portrait busts have received more attention or appreciation than
her other work. Author 1 briefly mentions her "other works," but mostly focuses on her historical and mythical works.
Author 2 states that art historians have typically ignored her portrait busts, which suggests that they haven''t
overshadowed her other work. Choice B is incorrect. Neither text explicitly states that The Death of Cleopatra is Lewis''s
most famous piece. Author 1 mentions it as one example of her historical works, but does not single it out as being more
important or influential than Hagar. Author 2 does not mention it at all, focusing instead on her portrait busts. Choice C is
incorrect. This choice isn''t supported by the texts. Neither text suggests that sculpting historical figures was a trend that
faded quickly.',
  'craft-structure',
  'easy',
  0,
...
-- Cross Text Connections | 7b55e895 | easy
(
  'mcq',
  'rw',
...
Based on the texts, both authors would most likely agree with which statement?',
  '[{"id":"a","text":"Tropical mountain bird species are restricted in where they can live."},{"id":"b","text":"Scientists have better tools to observe tropical mountain birds than they did in the past."},{"id":"c","text":"Little is known about how tropical mountain birds build their nests."},{"id":"d","text":"Tropical mountain bird species that live at high elevations tend to be genetically similar."}]'::jsonb,
  'a',
  'Choice A is the best answer. Both texts state that tropical mountain bird species have limited ranges or habitats,
although they disagree on the reason for this. Text 1 claims that temperature is the main factor that determines where
these birds can live, while Text 2 claims that competition with other species is the main factor. However, both texts agree
that these birds are not able to survive in many kinds of areas.
Choice B is incorrect. Neither text mentions the tools or methods that scientists use to observe these birds, either now or
in the past. Choice C is incorrect. Neither text mentions anything about how these birds build their nests. Choice D is
incorrect. Neither text provides any information about the genetic similarity of these birds, so we have no evidence that
either author would agree with this statement.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | 6977d22b | hard
(
  'mcq',
  'rw',
...
discussed in Text 1?',
  '[{"id":"a","text":"By arguing that it is based on a misconception about phytoplankton species competing with one another\nBy asserting that it fails to recognize that routine replenishment of ocean nutrients prevents competition between"},{"id":"b","text":"phytoplankton species\nBy suggesting that their own findings help clarify how phytoplankton species are able to compete with larger"},{"id":"c","text":"organisms\nBy recommending that more ecologists focus their research on how competition among phytoplankton species is"},{"id":"d","text":"increased with water density"}]'::jsonb,
  'a',
  'Choice A is the best answer because based on Text 2, it represents how Behrenfeld and colleagues would most likely
respond to the "conventional wisdom" discussed in Text 1. The conventional wisdom cited holds the opinion that when
there is species diversity within a phytoplankton population, "one species should emerge after outcompeting the rest"--
that is, after being so successful in competing for resources that the other species vanish from the population. However,
Text 2 explains that according to Behrenfeld and colleagues, phytoplankton are so small and spaced so far apart in the
water that there is "much less" direct competition for resources within phytoplankton populations than scientists had
previously thought.
Choice B is incorrect because Text 2 never discusses whether routine replenishment of ocean nutrients affects
competition between phytoplankton species. Choice C is incorrect because the interspecies competition discussed in
both texts is specifically between phytoplankton species, and neither text considers whether phytoplankton compete for
resources with larger nonphytoplankton species. Choice D is incorrect because according to Text 2, Behrenfeld and
colleagues argue that water density decreases, not increases, competition between phytoplankton species.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | 8889d6e2 | medium
(
  'mcq',
  'rw',
  'An excavation in Chiquihuite Cave in central Mexico has upended the belief that approximately 13,000 years ago, a group
known as the Clovis people were the first human inhabitants of North America. More than 200 crude stone tools were
found embedded in a layer of earth that is up to 33,150 years old, revealing that humans occupied the cave thousands of
years before the Clovis people reached the continent.
Text 2
The objects uncovered in Chiquihuite Cave are intriguing, but it is premature to characterize them as tools. The stone
pieces are so roughly shaped that they may have simply fractured from rocks during natural geological activity in the
cave. Moreover, their unearthing has thus far not been accompanied by discoveries of other signs of human activity or
even traces of human DNA from surfaces.
Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?
By suggesting that it draws a plausible connection between two groups of people but will need to be confirmed with',
  '[{"id":"a","text":"further study\nBy asserting that it rests on an assumption about the stone pieces that is not sufficiently supported by available"},{"id":"b","text":"evidence"},{"id":"c","text":"By acknowledging that it will most likely be proved correct when the stone pieces undergo more detailed analysis\nBy pointing out that it fails to account for evidence that the Clovis people were active on the continent as early as is"},{"id":"d","text":"commonly thought"}]'::jsonb,
  'b',
  'Choice B is the best answer because it reflects how the author of Text 2 would most likely respond to the underlined
claim about the Clovis people in Text 1. Text 1 explains that the idea that the Clovis people were the first human
inhabitants of North America has been overturned by the unearthing of stone tools in Chiquihuite Cave in Mexico. The
tools were found in a layer of earth that is over 33,000 years old--much older than the Clovis people''s arrival 13,000 years
ago. The text ends with the claim that the tools reveal that humans lived in the cave long before the Clovis people
reached the continent. Text 2, on the other hand, disputes the idea that the stone pieces are definitely tools. Text 2 states
that the pieces are so roughly shaped that they may have simply naturally broken off from rocks and, moreover, that no
other signs of human activity have been found in the cave. In other words, Text 2 argues that there is no proof yet that
humans made the pieces as tools or were even present in the cave. Therefore, the author of Text 2 would most likely say
that the claim that humans occupied Chiquihuite Cave long before the Clovis people reached North America rests on an
assumption about the stone pieces--that they are human-made tools--that is not sufficiently supported by available
evidence.
Choice A is incorrect because Text 1 doesn''t claim that human inhabitants of Chiquihuite Cave and the Clovis people had
any connection; the author of Text 1 focuses only on the timing of each group''s presence in North America. Further, the
author of Text 2 makes no mention of the Clovis people and indicates that it isn''t clear yet that any human group did
inhabit Chiquihuite Cave. Choice C is incorrect because nothing in Text 2 suggests that the author believes the stone
pieces probably are human-made tools and will be confirmed as such by further analysis; instead, the author of Text 2
emphasizes the current lack of evidence of human activity in the cave. Choice D is incorrect because Text 2 focuses on
the issue of characterizing the stone pieces as tools made by humans, not on the timing of any particular group''s activity
in North America; further, Text 1 seems to support the common belief that the Clovis people reached North America
13,000 years ago and challenges only the idea that they were the continent''s first inhabitants. Therefore, there''s no
reason to think the author of Text 2 would say that the author of Text 1 overlooks evidence that the Clovis people were
active as early as is commonly thought.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | f878693b | medium
(
  'mcq',
  'rw',
  'In 1954 George Balanchine choreographed a production of The Nutcracker, a ballet by Pyotr Ilyich Tchaikovsky. It has
since become a tradition for hundreds of dance companies in North America to stage The Nutcracker each year. But the
show is stuck in the past, with an old-fashioned story and references, so it should no longer be produced. Ballet needs to
create new traditions if it wants to stay relevant to contemporary audiences.
Text 2
...
Allen successfully modernized the story. Her show Hot Chocolate Nutcracker combines ballet, tap, hip-hop, and other
styles, and it has been gaining in popularity since it opened in 2009.
Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?
By questioning the idea that the story of The Nutcracker is stuck in the past and by rejecting the suggestion that',
  '[{"id":"a","text":"contemporary audiences would enjoy an updated version\nBy agreeing that contemporary audiences have largely stopped going to see performances of The Nutcracker"},{"id":"b","text":"because it''s so old-fashioned\nBy pointing out that most dance companies could increase their incomes by offering modernized versions of The"},{"id":"c","text":"Nutcracker\nBy suggesting that dance companies should consider offering revised versions of The Nutcracker instead of"},{"id":"d","text":"completely rejecting the show"}]'::jsonb,
  'd',
  'Choice D is the best answer because it reflects how the author of Text 2 would most likely respond to the underlined
claim in Text 1. Text 1 begins by noting the success of The Nutcracker but then claims that the ballet is "stuck in the past"
and should "no longer be produced." Text 2 begins by conceding that The Nutcracker is indeed outdated but argues that it
should continue to be performed, states that the show can be updated to include more contemporary dance styles, and
provides an example of one such modernized version, Hot Chocolate Nutcracker. Hence, the author of Text 2 would most
likely respond to the underlined claim in Text 1 by suggesting that dance companies should consider offering revised
versions of The Nutcracker instead of completely rejecting the show.
Choice A is incorrect because the author of Text 2 advocates for using creative ways to update The Nutcracker and
therefore wouldn''t respond to the underlined claim by rejecting the suggestion that contemporary audiences would enjoy
an updated version. Choice B is incorrect because although the authors of both texts claim that The Nutcracker is
outdated, neither text suggests that contemporary audiences have largely stopped attending productions of the show. On
the contrary, Text 2 states that The Nutcracker is a holiday favorite and generates substantial income for some dance
companies. Choice C is incorrect because although Text 2 provides an example of a contemporized version of The
Nutcracker, the text doesn''t suggest that offering modernized versions is a way to increase income for most dance
companies. Rather, the author of Text 2 suggests that offering modernized versions is a way to make the ballet
discussed in Text 1 feel less outdated.',
  'craft-structure',
  'medium',
  0,
  0,
...
-- Cross Text Connections | 88bb0f6f | easy
(
  'mcq',
  'rw',
...
The author of Text 2 approaches the study''s findings with some caution, whereas the author of Text 1 is optimistic',
  '[{"id":"a","text":"about the reported potential environmental benefits.\nThe author of Text 2 claims that the percentage of farmland identified by Strassburg''s team is too low for rewilding to"},{"id":"b","text":"achieve meaningful results, whereas the author of Text 1 thinks the percentage is sufficient.\nThe author of Text 2 believes that the results described by Strassburg''s team are achievable in the near future,"},{"id":"c","text":"whereas the author of Text 1 argues that they likely aren''t.\nThe author of Text 2 focuses on rewilding''s effect on carbon emissions, whereas the author of Text 1 focuses on its"},{"id":"d","text":"effect on biodiversity."}]'::jsonb,
  'a',
  'Choice A is the best answer. Text 1 is extremely positive about Strassburg''s team''s findings, calling the potential results
"a clear win in the fight against the biodiversity and climate crises." Text 2 is not as positive, arguing that while the
findings point to "potential benefits," we also need to consider the "potential effects on global food supplies."
...
effect that rewilding this much farmland would have on food supplies. Choice C is incorrect. This isn''t a difference
between the two views. Neither text mentions the timeline for achieving the results described by Strassburg''s team.
Choice D is incorrect. This isn''t a difference between the two views. Text 1 focuses on rewilding''s effects on both carbon
emissions and biodiversity. Text 2 doesn''t focus on rewilding''s effect on carbon emissions at all. Instead, it focuses on a
third factor: global food supplies.',
  'craft-structure',
  'easy',
  0,
  0,
...
-- Cross Text Connections | 35e21b06 | hard
(
  'mcq',
  'rw',
...
That behavior might have been due to the novelty of the magpies'' captive setting rather than to the novelty of the',
  '[{"id":"a","text":"tracker.\nThat behavior likely indicates that the magpies were deliberately attempting to benefit themselves by obtaining the"},{"id":"b","text":"tracker.\nThat behavior may not be evidence of selflessness in Gymnorhina tibicen because not all the captured magpies"},{"id":"c","text":"demonstrated it.\nThat behavior might be adequately explained without suggesting that the magpies were attempting to assist the"},{"id":"d","text":"other magpie."}]'::jsonb,
  'd',
  'Choice D is the best answer because it reflects how the author of Text 2 would most likely respond to the researchers''
perspective in Text 1 on the behavior of the magpies without trackers. According to Text 1, Dominique Potvin and
colleagues observed magpies without trackers pecking at a tracker on another magpie until the device fell off. The
researchers suggested that the birds might have been attempting to help the other bird, with no benefit to themselves.
Text 2 generally discusses scenarios in which animals have been observed removing trackers from each other. The text
cautions that it shouldn''t be assumed that these animals are helping one another deliberately, since they might simply be
pecking at trackers out of curiosity, causing them to fall off eventually. Therefore, the author of Text 2 would most likely
respond to Potvin and colleagues'' perspective in Text 1 by saying that the behavior of the magpies without trackers could
be adequately explained without suggesting that they were attempting to assist the other magpie.
Choice A is incorrect because Text 2 never discusses the novelty, or the newness and unusual quality, of the captive
settings in which animals have been observed to remove trackers from other animals, nor does it suggest that such
novelty might account for this behavior. Instead, the text suggests that it''s the novelty of the tracking equipment itself
that might cause the behavior: interested in the trackers because they''re unusual, animals might paw or peck at them
until they fall off. Choice B is incorrect because Text 2 never suggests that when animals remove trackers from other
animals, they do so because they wish to obtain the trackers for themselves. Instead, Text 2 argues that animals paw or
peck at trackers because they are merely curious about them. Choice C is incorrect because Text 2 doesn''t argue that
when captured animals are observed removing trackers from each other, their behavior should be regarded as selfless
only if all of them participate in it. Instead, the text argues that the behavior may not be selfless at all and may instead be
attributed to animals'' curiosity about the new and unusual trackers.',
  'craft-structure',
  'hard',
  0,
  0,
...
-- Cross Text Connections | f52cc78c | medium
(
  'mcq',
  'rw',
...
underlined portion of Text 1?',
  '[{"id":"a","text":"By noting that it neglects the possibility of some polar bear populations adapting to changes in their environment\nBy suggesting that it is likely incorrect about the rates at which warming ocean temperatures have caused sea ice to"},{"id":"b","text":"melt in the Arctic"},{"id":"c","text":"By asserting that it overlooks polar bear populations that have not yet been affected by loss of seal-hunting habitats"},{"id":"d","text":"By arguing that it fails to account for polar bears'' reliance on a single seal-hunting strategy"}]'::jsonb,
  'a',
...
Choice B is incorrect. Text 2 does not challenge the fact that sea ice is rapidly declining in the Arctic due to warming
ocean temperatures. In fact, it states that the Svalbard polar bears have faced "rapidly declining sea ice in recent years."
Choice C is incorrect. The claim in Text 1 is specific to polar bear populations affected by the loss of seal hunting
habitats, so unaffected populations are irrelevant to the claim. Also, Text 2 doesn''t mention any polar bear populations
that haven''t yet been affected by loss of seal hunting habitats. It focuses on a population that has been affected by sea-
ice loss but has managed to survive and thrive nevertheless. Choice D is incorrect. Text 2 doesn''t imply that polar bears
rely on a single seal-hunting strategy. In fact, the researcher in Text 2 would say that Text 1 fails to account for polar
bears'' ability to develop other hunting strategies and food sources.',
  'craft-structure',
  'medium',
  0,
  0,
...
(
  ...
  '[{"id":"a","text":"indicated by"},{"id":"b","text":"handmade from"},{"id":"c","text":"represented by"},{"id":"d","text":"collected with"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'The invention in 1958 of the integrated circuit (or microchip) radically altered the semiconductor industry. In fact, some historians argue that it fundamentally ______ the industry by enabling it to take advantage of mass production methods for the first time. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"overwhelmed"},{"id":"b","text":"bypassed"},{"id":"c","text":"obstructed"},{"id":"d","text":"transformed"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"reduced"},{"id":"b","text":"evaluated"},{"id":"c","text":"determined"},{"id":"d","text":"acquired"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"proficient"},{"id":"b","text":"dogmatic"},{"id":"c","text":"ambiguous"},{"id":"d","text":"unpretentious"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"surmised"},{"id":"b","text":"contrived"},{"id":"c","text":"questioned"},{"id":"d","text":"regretted"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"Disorganized"},{"id":"b","text":"Alarmed"},{"id":"c","text":"Offended"},{"id":"d","text":"Interrupted"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"waive"},{"id":"b","text":"concede"},{"id":"c","text":"refute"},{"id":"d","text":"require"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'The works of Chicana artist Ester Hernandez are now ______ in museums both in the United States and abroad, but the murals she contributed to as a member of Las Mujeres Muralistas early in her artistic career were displayed in outdoor public spaces across San Francisco. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"invented"},{"id":"b","text":"adjusted"},{"id":"c","text":"featured"},{"id":"d","text":"recommended"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"demands"},{"id":"b","text":"speculates"},{"id":"c","text":"doubts"},{"id":"d","text":"establishes"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"cause"},{"id":"b","text":"existence"},{"id":"c","text":"implication"},{"id":"d","text":"scale"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"prepared for"},{"id":"b","text":"inexperienced with"},{"id":"c","text":"skilled in"},{"id":"d","text":"excited about"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"repudiates"},{"id":"b","text":"proclaims"},{"id":"c","text":"foretells"},{"id":"d","text":"recants"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'According to botanists, a viburnum plant experiencing insect damage may develop erineum-a discolored, felty growth- on its leaf blades. A ______ viburnum plant, on the other hand, will have leaves with smooth surfaces and uniformly green coloration. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"struggling"},{"id":"b","text":"beneficial"},{"id":"c","text":"simple"},{"id":"d","text":"healthy"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"reflect"},{"id":"b","text":"receive"},{"id":"c","text":"evaluate"},{"id":"d","text":"mimic"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"Restricted"},{"id":"b","text":"Described"},{"id":"c","text":"Developed"},{"id":"d","text":"Settled"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"legitimate"},{"id":"b","text":"impenetrable"},{"id":"c","text":"compelling"},{"id":"d","text":"indecipherable"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"recognizable"},{"id":"b","text":"fragile"},{"id":"c","text":"common"},{"id":"d","text":"sophisticated"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"newfound"},{"id":"b","text":"delicate"},{"id":"c","text":"inevitable"},{"id":"d","text":"habitual"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"accuracy"},{"id":"b","text":"inactivity"},{"id":"c","text":"complexity"},{"id":"d","text":"restraint"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"Demanding"},{"id":"b","text":"Signaling"},{"id":"c","text":"Inviting"},{"id":"d","text":"Shifting"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"acknowledges"},{"id":"b","text":"produces"},{"id":"c","text":"spans"},{"id":"d","text":"advances"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'In the early 1800s, the Cherokee scholar Sequoyah created the first script, or writing system, for an Indigenous language in the United States. Because it represented the sounds of spoken Cherokee so accurately, his script was easy to learn and thus quickly achieved ______ use: by 1830, over 90 percent of the Cherokee people could read and write it. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"widespread"},{"id":"b","text":"careful"},{"id":"c","text":"unintended"},{"id":"d","text":"infrequent"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"validate"},{"id":"b","text":"interpret"},{"id":"c","text":"relate"},{"id":"d","text":"accommodate"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"circumvents"},{"id":"b","text":"eclipses"},{"id":"c","text":"fabricates"},{"id":"d","text":"exemplifies"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"resilient"},{"id":"b","text":"inadequate"},{"id":"c","text":"dynamic"},{"id":"d","text":"satisfactory"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'Bioluminescent beetles called fireflies may seem to create flashes of light randomly, but each species of firefly actually has its own special series of repeated flashes and pauses. These unique ______ allow fireflies of the same species to find each other. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"quantities"},{"id":"b","text":"decorations"},{"id":"c","text":"patterns"},{"id":"d","text":"agreements"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'According to Potawatomi ecologist Robin Wall Kimmerer, the Indigenous method of harvesting Hierochloe odorata, or sweetgrass, by snapping the plant off at the root actually ______ wild populations: it may seem counterintuitive, she says, but this method of removal allows new sweetgrass plants to repopulate the space, with an overall increase in number and vigor. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"selects"},{"id":"b","text":"originates"},{"id":"c","text":"conditions"},{"id":"d","text":"replenishes"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"epitomizing"},{"id":"b","text":"transcending"},{"id":"c","text":"anticipating"},{"id":"d","text":"reinforcing"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"overlooked"},{"id":"b","text":"powerful"},{"id":"c","text":"routine"},{"id":"d","text":"variable"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"deceptive"},{"id":"b","text":"innocuous"},{"id":"c","text":"novel"},{"id":"d","text":"impractical"}]'::jsonb,
  'b',
...
-- words | 9107ad5c | medium
(
  'mcq',
  'rw',
  'Stars form in cloudlike swirls of gas and dust that cannot be touched‚ but astrophysicist Nia Imara believes these formations need not remain completely ______ to researchers: she uses simulation data and sophisticated 3D printers to produce interactive models of these stellar nurseries. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"repeatable"},{"id":"b","text":"explicable"},{"id":"c","text":"regrettable"},{"id":"d","text":"intangible"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"impartial"},{"id":"b","text":"offhand"},{"id":"c","text":"persistent"},{"id":"d","text":"mandatory"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"responsiveness to"},{"id":"b","text":"ambivalence toward"},{"id":"c","text":"renunciation of"},{"id":"d","text":"mastery over"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"occupy"},{"id":"b","text":"hoard"},{"id":"c","text":"reserve"},{"id":"d","text":"obtain"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'Particle physicists like Ayana Holloway Arce and Aida El-Khadra spend much of their time ______ what is invisible to the naked eye: using sophisticated technology, they closely examine the behavior of subatomic particles, the smallest detectable parts of matter. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"selecting"},{"id":"b","text":"inspecting"},{"id":"c","text":"creating"},{"id":"d","text":"deciding"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"scholarly"},{"id":"b","text":"melodic"},{"id":"c","text":"jarring"},{"id":"d","text":"personal"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"sturdily"},{"id":"b","text":"carelessly"},{"id":"c","text":"rarely"},{"id":"d","text":"simply"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"delegate"},{"id":"b","text":"compose"},{"id":"c","text":"interpret"},{"id":"d","text":"renounce"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"invent"},{"id":"b","text":"simulate"},{"id":"c","text":"exaggerate"},{"id":"d","text":"preserve"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'The following text is from the 1989 novel The Ancient Child by Kiowa writer N. Scott Momaday. The main character has achieved tremendous commercial success as a painter. More and more often he was asked to compromise his art or himself in one way or another, and more often than not he did so, for he was inclined to be passive and naïve; it was difficult for him to say no. Those who exhibited his work, who praised and purchased it, and who demanded its proliferation began to determine it. ©1989 by N. Scott Momaday As used in the text, what does the word "determine" most nearly mean?',
  '[{"id":"a","text":"Conclude"},{"id":"b","text":"Dictate"},{"id":"c","text":"Evaluate"},{"id":"d","text":"Select"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'In 1877, 85% of California''s railways were already controlled by the Southern Pacific Railroad. The company further solidified its ______ in rail access to the state''s Pacific coast when it completed the Sunset Route in 1883: running from Louisiana to Southern California, the route established the first transcontinental rail line across the southern United States. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"dominance"},{"id":"b","text":"creativity"},{"id":"c","text":"insignificance"},{"id":"d","text":"neutrality"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"a disconcerting"},{"id":"b","text":"an acceptable"},{"id":"c","text":"an imperceptible"},{"id":"d","text":"a substantial"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"a collaboration"},{"id":"b","text":"an accessory"},{"id":"c","text":"a contradiction"},{"id":"d","text":"an analogy"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"controversial among"},{"id":"b","text":"antagonistic toward"},{"id":"c","text":"imitated by"},{"id":"d","text":"inconsequential to"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"disengage"},{"id":"b","text":"annotate"},{"id":"c","text":"buttress"},{"id":"d","text":"reciprocate"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'Whether Carmen Lomas Garza is creating small paintings and illustrations or large public artworks-such as Baile, a copper cutout of traditional Mexican dance in the San Francisco International Airport-she is ______ direct experience, drawing from memories of her childhood in Texas or details of her current surroundings in California. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"complimented by"},{"id":"b","text":"uncertain about"},{"id":"c","text":"unbothered by"},{"id":"d","text":"inspired by"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'Like other tribal nations, the Muscogee (Creek) Nation is self-governing; its National Council generates laws regulating aspects of community life such as land use and healthcare, while the principal chief and cabinet officials ______ those laws by devising policies and administering services in accordance with them. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"implement"},{"id":"b","text":"presume"},{"id":"c","text":"improvise"},{"id":"d","text":"mimic"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"conceptualize"},{"id":"b","text":"neglect"},{"id":"c","text":"illustrate"},{"id":"d","text":"overcome"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"prevail"},{"id":"b","text":"succumb"},{"id":"c","text":"diverge"},{"id":"d","text":"intersect"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'Manul cats are small, shy felines. They live mostly alone in out-of-the-way parts of Asia, such as on Mount Everest. These cats have been difficult to research because their habitats are so ______ large populations of humans. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"full of"},{"id":"b","text":"drawn to"},{"id":"c","text":"responsible for"},{"id":"d","text":"distant from"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'Radar and sonar can detect objects or people through walls, but they are too costly for consumer use. Researchers Fadel Adib and Dina Katabi have shown, however, that there may be a comparatively ______ alternative: small changes to the Wi-Fi technology used in smartphones can give users a cheap way to count people or even identify their gestures through walls. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"infrequent"},{"id":"b","text":"inexpensive"},{"id":"c","text":"unmistakable"},{"id":"d","text":"impractical"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"responsive"},{"id":"b","text":"inactive"},{"id":"c","text":"liked"},{"id":"d","text":"distressed"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"Choose"},{"id":"b","text":"Influence"},{"id":"c","text":"Demonstrate"},{"id":"d","text":"Measure"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"indifference to"},{"id":"b","text":"enthusiasm for"},{"id":"c","text":"concern about"},{"id":"d","text":"surprise at"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"complementary"},{"id":"b","text":"unknown"},{"id":"c","text":"disparate"},{"id":"d","text":"interchangeable"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'The following text is adapted from Lewis Carroll''s 1871 novel Through the Looking-Glass, and What Alice Found There. Alice, a child, is talking to her cat. "Do you hear the snow against the window-panes, Kitty? How nice and soft it sounds! Just as if someone was kissing the window all over outside." As used in the text, what does the word "soft" most nearly mean?',
  '[{"id":"a","text":"Gentle"},{"id":"b","text":"Sensitive"},{"id":"c","text":"Shapeless"},{"id":"d","text":"Bland"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"overreacts"},{"id":"b","text":"reciprocates"},{"id":"c","text":"retaliates"},{"id":"d","text":"deviates"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'Although critics believed that customers would never agree to pay to pick their own produce on farms, such concerns didn''t ______ Booker T. Whatley''s efforts to promote the practice. Thanks in part to Whatley''s determined advocacy, farms that allow visitors to pick their own apples, pumpkins, and other produce can be found throughout the United States. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"enhance"},{"id":"b","text":"hinder"},{"id":"c","text":"misrepresent"},{"id":"d","text":"aggravate"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'Researcher Lucy Salazar is using radiocarbon dating to study Machu Picchu, an ancient Incan fortress in the Andes Mountains. She and her colleagues have found that the site''s age differs from the ______ estimate: it is approximately 20 years older than scholars thought when first encountering Machu Picchu in 1911. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"genuine"},{"id":"b","text":"intentional"},{"id":"c","text":"independent"},{"id":"d","text":"original"}]'::jsonb,
  'd',
...
-- words | 2e8ab360 | medium
(
  'mcq',
  'rw',
  'Eighteenth-century historian Edward Gibbon thought the only character defect of the Roman emperor Marcus Aurelius was his mild temperament-though the emperor was widely considered virtuous, his overly permissive nature led him to ______ the vices of those who surrounded him. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"indulge"},{"id":"b","text":"despise"},{"id":"c","text":"moderate"},{"id":"d","text":"criticize"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'Novelist Leon Forrest admired William Faulkner''s writing style. Forrest''s novel Divine Days contains a long passage in tribute to Faulkner that is a perfect ______ of Faulkner''s style: anyone familiar with Faulkner''s writing would see the resemblance. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"forgetting"},{"id":"b","text":"rejection"},{"id":"c","text":"imitation"},{"id":"d","text":"opinion"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"surpassed by"},{"id":"b","text":"comparable to"},{"id":"c","text":"independent of"},{"id":"d","text":"obtained from"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'Although the playwrights hoped that their play would be ______ when performed live, critics generally agreed that the production and performances had the opposite effect, wearying audiences instead of energizing them. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"multifaceted"},{"id":"b","text":"realistic"},{"id":"c","text":"rousing"},{"id":"d","text":"subtle"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'The following text is from Darcie Little Badger''s 2021 novel A Snake Falls to Earth. Nina is looking at old family photographs. Nina couldn''t stop looking at the sepia-toned photograph in an oak frame. Propped on the window ledge, it featured a portrait of Great-Great-Grandmother Rosita as a young woman. ©2021 by Darcie Little Badger As used in the text, what does the word "featured" most nearly mean?',
  '[{"id":"a","text":"Displayed"},{"id":"b","text":"Questioned"},{"id":"c","text":"Approved"},{"id":"d","text":"Ignored"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"indecipherable"},{"id":"b","text":"ornamental"},{"id":"c","text":"obscure"},{"id":"d","text":"intricate"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'The printing of Virginia Woolf''s novels featured a creative ______ between Woolf and her sister Vanessa Bell: a talented painter, Bell worked closely with Woolf to create original cover art for most of the novels. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"rebellion"},{"id":"b","text":"partnership"},{"id":"c","text":"discovery"},{"id":"d","text":"disagreement"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"attached"},{"id":"b","text":"collected"},{"id":"c","text":"followed"},{"id":"d","text":"replaced"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"synchronization"},{"id":"b","text":"hibernation"},{"id":"c","text":"prediction"},{"id":"d","text":"moderation"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"Joining with"},{"id":"b","text":"Gaining on"},{"id":"c","text":"Stretching toward"},{"id":"d","text":"Arriving at"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'Physicist Joseph Weber performed ______ work in gravitational wave research in the 1960s and 1970s, conducting key experiments that scientists later used as the basis for their own investigations that led to the first verified detection of a gravitational wave in 2015. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"foundational"},{"id":"b","text":"supplementary"},{"id":"c","text":"repetitive"},{"id":"d","text":"ineffective"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'As an architect in Los Angeles in the 1950s, Helen Liu Fong became known for avoiding ______ designs in her buildings. Instead of using standard shapes and colors, she typically explored innovative forms and daring hues. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"creative"},{"id":"b","text":"bold"},{"id":"c","text":"traditional"},{"id":"d","text":"understandable"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"substantial"},{"id":"b","text":"satisfying"},{"id":"c","text":"unimportant"},{"id":"d","text":"appropriate"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"examples of"},{"id":"b","text":"concerns about"},{"id":"c","text":"indications of"},{"id":"d","text":"similarities with"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"defunct"},{"id":"b","text":"arcane"},{"id":"c","text":"ubiquitous"},{"id":"d","text":"extraneous"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"insensible to"},{"id":"b","text":"manifest in"},{"id":"c","text":"scrutinized by"},{"id":"d","text":"complicated by"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"interjected"},{"id":"b","text":"committed"},{"id":"c","text":"illustrated"},{"id":"d","text":"prescribed"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"borrows"},{"id":"b","text":"spans"},{"id":"c","text":"judges"},{"id":"d","text":"neglects"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"deliberation"},{"id":"b","text":"vigilance"},{"id":"c","text":"interest"},{"id":"d","text":"consensus"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'For her 2021 art installation Anthem, Wu Tsang joined forces with singer and composer Beverly Glenn-Copeland to produce a piece that critics found truly ______: they praised Tsang for creatively transforming a museum rotunda into a dynamic exhibit by projecting filmed images of Glenn-Copeland onto a massive 84-foot curtain and filling the space with the sounds of his and other voices singing. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"restrained"},{"id":"b","text":"inventive"},{"id":"c","text":"inexplicable"},{"id":"d","text":"mystifying"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"secretive"},{"id":"b","text":"efficient"},{"id":"c","text":"outgoing"},{"id":"d","text":"unsympathetic"}]'::jsonb,
  'b',
...
-- words | e37b9e34 | medium
(
  'mcq',
  'rw',
  'Some researchers believe that the genes that enable groundhogs and certain other mammals to hibernate through the winter by slowing their breathing and heart rates and lowering their body temperature may be ______ in humans: present yet having essentially no effect on our bodily processes. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"decisive"},{"id":"b","text":"lacking"},{"id":"c","text":"variable"},{"id":"d","text":"dormant"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'The early British postal system required the cost of mail delivery to be paid upon receipt, a system which encouraged inventive strategies by the intended recipient to avoid payment. To improve this system, ______ were proposed in 1837, including the use of a postage stamp, a small receipt pasted to the mail indicating that delivery costs had been paid by the sender. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"investigations"},{"id":"b","text":"expansions"},{"id":"c","text":"reforms"},{"id":"d","text":"possessions"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"require"},{"id":"b","text":"remember"},{"id":"c","text":"foster"},{"id":"d","text":"discourage"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"recognizable"},{"id":"b","text":"intriguing"},{"id":"c","text":"significant"},{"id":"d","text":"useful"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"skeptical"},{"id":"b","text":"observant"},{"id":"c","text":"critical"},{"id":"d","text":"confident"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"involuntarily"},{"id":"b","text":"beneficially"},{"id":"c","text":"strenuously"},{"id":"d","text":"smoothly"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'A unique dialect, or regional variety, of Spanish is spoken in Puerto Rico. It contains many words borrowed from the language of the Taínos, the Indigenous people of Puerto Rico. African languages also made important contributions to the Puerto Rican dialect. For example, the way certain vowel sounds are pronounced in it can be ______ to how they are pronounced in Yoruba, a West African language. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"traced"},{"id":"b","text":"surrendered"},{"id":"c","text":"announced"},{"id":"d","text":"offered"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"acknowledged"},{"id":"b","text":"ensured"},{"id":"c","text":"denied"},{"id":"d","text":"underestimated"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'Urban planning expert Francisco Lara-Valencia and colleagues have argued that managing environmental matters along the US-Mexico border ______ coordination between the two countries'' governments. Since ecosystems extend across the border, actions taken on one side can have environmental effects on the other side, making international cooperation essential. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"requires"},{"id":"b","text":"praises"},{"id":"c","text":"reports"},{"id":"d","text":"advises"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'Some people have speculated that two helmets with attached horns discovered in Denmark in 1942 belonged to Vikings, but scholars have long been skeptical. Archaeologist Helle Vandkilde and colleagues recently provided radiocarbon dates for the helmets, and their findings ______ scholars'' skepticism: the helmets date to the Nordic Bronze Age, centuries before the Vikings existed. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"anticipate"},{"id":"b","text":"inspect"},{"id":"c","text":"reveal"},{"id":"d","text":"justify"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"Trace"},{"id":"b","text":"Opinion"},{"id":"c","text":"Dispute"},{"id":"d","text":"Command"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"recommend"},{"id":"b","text":"criticize"},{"id":"c","text":"impede"},{"id":"d","text":"construct"}]'::jsonb,
  'c',
  'Choice C is the best answer. The first sentence tells us that video meetings are "less conducive to" (meaning less good for) brainstorming. This suggests that the video meeting participants'' focus is bad for their creativity. "Impede" means "delay" or "prevent," which works perfectly in this context. Choice A is incorrect. This choice is too positive to fit the context. The first sentence tells us that video meetings are "less conducive to" (meaning less good for) brainstorming. This suggests that the video meeting participants'' focus is bad for their creativity. Choice B is incorrect. This choice doesn''t make sense. The participants'' intense focus on the screen is the subject of the missing verb. It wouldn''t make sense to say that their over-focusing "criticizes" their creativity. Choice D is incorrect. "Construct" means "build" or "make," which is too positive to fit the context. The first sentence tells us that video meetings are "less conducive to" (meaning less good for) brainstorming. This suggests that the video meeting participants'' focus is bad for their creativity.',
  'craft-structure',
  'medium',
  0,
  0,
...
(
  ...
  '[{"id":"a","text":"unpredictable"},{"id":"b","text":"important"},{"id":"c","text":"secretive"},{"id":"d","text":"ordinary"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'The fashion resale market, in which consumers purchase secondhand clothing from stores and online sellers, generated nearly $30 billion globally in 2019. Expecting to see continued growth, some analysts ______ that revenues will more than double by 2028. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"produced"},{"id":"b","text":"denied"},{"id":"c","text":"worried"},{"id":"d","text":"predicted"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"pragmatic"},{"id":"b","text":"controversial"},{"id":"c","text":"extensive"},{"id":"d","text":"universal"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"Evidence"},{"id":"b","text":"Blemish"},{"id":"c","text":"Amount"},{"id":"d","text":"Sketch"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"haphazard"},{"id":"b","text":"premeditated"},{"id":"c","text":"inspirational"},{"id":"d","text":"fruitless"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"characterization"},{"id":"b","text":"interpretation"},{"id":"c","text":"collaboration"},{"id":"d","text":"commercialization"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"dispute"},{"id":"b","text":"withdraw"},{"id":"c","text":"underscore"},{"id":"d","text":"invalidate"}]'::jsonb,
  'd',
...
-- words | f4166aae | medium
(
  'mcq',
  'rw',
  'In addition to being an accomplished psychologist himself, Francis Cecil Sumner was a ______ increasing the opportunity for Black students to study psychology, helping to found the psychology department at Howard University, a historically Black university, in 1930. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"proponent of"},{"id":"b","text":"supplement to"},{"id":"c","text":"beneficiary of"},{"id":"d","text":"distraction for"}]'::jsonb,
  'a',
...
(
  'mcq',
  'rw',
  'Logically, a damaged fossil should provide less information than an intact one, but for paleontologist Brigitte Schoenemann, a broken area on a fossilized trilobite (a crustacean-like creature) ______ fresh insight, allowing her to view the inner structure of the organism''s eye. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"resolved"},{"id":"b","text":"adjusted"},{"id":"c","text":"offered"},{"id":"d","text":"directed"}]'::jsonb,
  'c',
...
-- words | 1107e7dc | medium
(
  'mcq',
  'rw',
  'Economists often assert that countries looking to increase their reliance on solar energy should expand their capacity for storage; having an ample reserve of stored energy can mitigate the effects of ______ solar energy collection caused by unpredictable shifts in cloud cover and haze. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"developments of"},{"id":"b","text":"fluctuations in"},{"id":"c","text":"calibrations with"},{"id":"d","text":"incentives for"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"aggressive"},{"id":"b","text":"rudimentary"},{"id":"c","text":"evolving"},{"id":"d","text":"advantageous"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"compliance with"},{"id":"b","text":"exposure to"},{"id":"c","text":"criteria for"},{"id":"d","text":"forfeiture of"}]'::jsonb,
  'b',
  'Choice B is the best answer. "Exposure to" means "having contact with." It makes sense that Prasad and Bainbridge were investigating whether seeing false versions of images was a cause of false visual memories. Notice how "exposure to incorrect renditions" matches the idea of "familiarity with erroneous versions," which appears later in the sentence. Choice A is incorrect. "Compliance with" means "going along with a command or directive." False versions of images can''t give commands or directives, so this doesn''t apply. Choice C is incorrect. "Criteria" means "standards by which to judge something." It''s not clear how people would come to have standards for the wrong version of an image in the first place, let alone how those standards would cause them to falsely remember the correct version. In other words, this choice would result in a confusing, unclear sentence. Choice D is incorrect. "Forfeiture of" means "a giving up of something." It wouldn''t make sense to say that false memories of an image might be caused by giving up the wrong version of the image.',
  'craft-structure',
  'hard',
  0,
  0,
...
(
  'mcq',
  'rw',
  'Shoppers can help keep money cycling within a community by making purchases at small local businesses instead of large retailers. Some cities are ______ programs to encourage this behavior, establishing reward points and other incentives for shopping at small businesses. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"instituting"},{"id":"b","text":"occupying"},{"id":"c","text":"underestimating"},{"id":"d","text":"encountering"}]'::jsonb,
  'a',
...
-- words | 6c64a8f3 | medium
(
  'mcq',
  'rw',
  'Ecologist Exequiel Ezcurra and colleagues found that the inhabitants of the Mexica empire used natural landmarks to track time with a high degree of ______. By observing the sun''s position in relation to various points on the mountains surrounding the Basin of Mexico, the Mexica were able to precisely identify the dates when significant events such as solstices occurred. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"precariousness"},{"id":"b","text":"exactitude"},{"id":"c","text":"resilience"},{"id":"d","text":"inconspicuousness"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"A useless"},{"id":"b","text":"An empty"},{"id":"c","text":"A forgotten"},{"id":"d","text":"An incomplete"}]'::jsonb,
  'b',
...
-- words | 6a1194e8 | medium
(
  'mcq',
  'rw',
  'Rydra Wong, the protagonist of Samuel R. Delany''s 1966 novel Babel-17, is a poet, an occupation which, in Delany''s work, is not ______: nearly a dozen of the characters that populate his novels are poets or writers. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"infallible"},{"id":"b","text":"atypical"},{"id":"c","text":"lucrative"},{"id":"d","text":"tedious"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"a prudently"},{"id":"b","text":"an overtly"},{"id":"c","text":"a cordially"},{"id":"d","text":"an inadvertently"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"reviewed"},{"id":"b","text":"defied"},{"id":"c","text":"respected"},{"id":"d","text":"prevented"}]'::jsonb,
  'b',
  'Choice B is the best answer. "Defied" means "resisted" or "deliberately disobeyed," which matches the way Klein broke from the conventions of photography in his time by including features that were generally seen as flaws. Choice A is incorrect. "Reviewed" means "analyzed" or "evaluated," but that doesn''t really fit the context here. Klein isn''t directly providing any thoughtful examination of the conventions of photography: he''s just breaking all the rules. Choice C is incorrect. "Respected" can mean "admired" or "followed" (as in the case of conventions). It''s clear that Klein didn''t respect conventions, given his use of photographic features that were generally considered "flaws." Choice D is incorrect. "Prevented" means "stopped," and Klein did not stop the conventions-they still existed. Instead, he made images that were seen as "flawed" under those conventions.',
  'craft-structure',
  'easy',
  0,
  0,
...
(
  ...
  '[{"id":"a","text":"validated"},{"id":"b","text":"created"},{"id":"c","text":"challenged"},{"id":"d","text":"restored"}]'::jsonb,
  'b',
...
(
  'mcq',
  'rw',
  'The following text is from Mark Oshiro''s 2018 novel Anger Is a Gift. In the novel, Moss and his friends are on a subway train in Northern California. Lights from the outside world then filled the train car as it rose out of the ground and climbed the elevated track. As long as Moss had lived in West Oakland, he''d never tired of this specific view, so he pointed toward the windows. "Check it," he said, and the Port of Oakland began to pass by them. ©2018 by Mark Oshiro As used in the text, what does the word "specific" most nearly mean?',
  '[{"id":"a","text":"Imaginary"},{"id":"b","text":"Energetic"},{"id":"c","text":"Correct"},{"id":"d","text":"Particular"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"intriguing"},{"id":"b","text":"obvious"},{"id":"c","text":"accidental"},{"id":"d","text":"observable"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'The following text is adapted from Lewis Carroll''s 1865 novel Alice''s Adventures in Wonderland. "The second thing is to find my way into that lovely garden. I think that will be the best plan." It sounded like an excellent plan, no doubt, and very neatly and simply arranged; the only difficulty was, that Alice had not the smallest idea how to set about it. As used in the text, what does the word "simply" most nearly mean?',
  '[{"id":"a","text":"Faintly"},{"id":"b","text":"Hastily"},{"id":"c","text":"Easily"},{"id":"d","text":"Foolishly"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"predicting"},{"id":"b","text":"refusing"},{"id":"c","text":"hiding"},{"id":"d","text":"creating"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"hypothesized"},{"id":"b","text":"discounted"},{"id":"c","text":"redefined"},{"id":"d","text":"exploited"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"disorienting"},{"id":"b","text":"tenuous"},{"id":"c","text":"nuanced"},{"id":"d","text":"unoriginal"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"replicable"},{"id":"b","text":"predetermined"},{"id":"c","text":"operative"},{"id":"d","text":"latent"}]'::jsonb,
  'd',
...
(
  ...
  '[{"id":"a","text":"unobtrusive"},{"id":"b","text":"concealed"},{"id":"c","text":"approximate"},{"id":"d","text":"peripheral"}]'::jsonb,
  'd',
...
(
  'mcq',
  'rw',
  'K.D. Leka and colleagues found that the Sun''s corona provides an advance indication of solar flares-intense eruptions of electromagnetic radiation that emanate from active regions in the Sun''s photosphere and can interfere with telecommunications on Earth. Preceding a flare, the corona temporarily exhibits increased brightness above the region where the flare is ______. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"antecedent"},{"id":"b","text":"impending"},{"id":"c","text":"innocuous"},{"id":"d","text":"perpetual"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"preventable"},{"id":"b","text":"undeniable"},{"id":"c","text":"common"},{"id":"d","text":"concerning"}]'::jsonb,
  'a',
...
(
  ...
  '[{"id":"a","text":"derived from"},{"id":"b","text":"recognized in"},{"id":"c","text":"confined to"},{"id":"d","text":"repressed by"}]'::jsonb,
  'c',
...
(
  'mcq',
  'rw',
  'Latro, the main character of Gene Wolfe''s novel Soldier of the Mist, is a man in ancient Greece. He completely loses his memory whenever he sleeps. So, before sleeping, Latro records the important experiences of each day on a scroll, carefully choosing which ones to ______. Which choice completes the text with the most logical and precise word or phrase?',
  '[{"id":"a","text":"suspect"},{"id":"b","text":"preserve"},{"id":"c","text":"suggest"},{"id":"d","text":"imagine"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"inevitable"},{"id":"b","text":"satisfactory"},{"id":"c","text":"negligible"},{"id":"d","text":"commonplace"}]'::jsonb,
  'c',
...
(
  ...
  '[{"id":"a","text":"experiment with"},{"id":"b","text":"adhere to"},{"id":"c","text":"improve on"},{"id":"d","text":"grapple with"}]'::jsonb,
  'b',
...
(
  ...
  '[{"id":"a","text":"distinct"},{"id":"b","text":"required"},{"id":"c","text":"unintended"},{"id":"d","text":"unknown"}]'::jsonb,
  'a',
