-- Seed: CBSE 10 Science flashcards
-- Source: Docs for me/latex_with_rijay/cbse_10_science/flashcards.csv
-- 75 cards: 28 Chemical Reactions, 43 Electricity, 4 mixed (rows 59,62,66-71)
--
-- Stored as type='spr', is_flashcard=true, difficulty_tier='easy'.
-- prompt  = front of card (question)
-- correct_answer = back of card (answer)
-- Dollar-quoted with $fc$...$fc$ to safely embed LaTeX backslashes & single quotes.
...
-- ── Chemical Reactions and Equations (rows 1–28) ──────────────────────────
...
-- ── Chemical Reactions continued (row 59) ────────────────────────────────
...
-- ── Electricity continued (rows 60–61, 63–65) ────────────────────────────
...
-- ── Chemical Reactions continued (row 62) ────────────────────────────────
...
-- ── Electricity continued (rows 63–65) ───────────────────────────────────
...
-- ── Chemical Reactions continued (rows 66–71) ────────────────────────────
...
-- ── Electricity continued (rows 72–75) ───────────────────────────────────
