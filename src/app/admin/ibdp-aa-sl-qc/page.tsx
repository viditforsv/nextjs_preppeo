...
const config: QCPageConfig<IBDPQCQuestion> = {
  title: 'IB AA SL Questions QC',
  breadcrumbLabel: 'IB AA SL QC',
  subtitle: 'Review and edit all IB Mathematics Analysis & Approaches SL questions.',
  apiBase: '/api/admin/ibdp-aa-sl-questions',
  hasImageUpload: true,
  ...
  metadataBadges: [
    { key: 'domain', render: (q) => q.domain ? <Badge className="bg-indigo-100 text-indigo-800 text-xs">{IBDP_DOMAIN_LABELS[q.domain as keyof typeof IBDP_DOMAIN_LABELS] ?? q.domain}</Badge> : null },
...
export default function IBDPAASLQCPage() {
