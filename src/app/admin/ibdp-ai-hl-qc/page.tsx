...
const config: QCPageConfig<IBDPQCQuestion> = {
  title: 'IB AI HL Questions QC',
  breadcrumbLabel: 'IB AI HL QC',
  subtitle: 'Review and edit all IB Mathematics Applications & Interpretation HL questions.',
  apiBase: '/api/admin/ibdp-ai-hl-questions',
  hasImageUpload: true,
  ...
  metadataBadges: [
    { key: 'domain', render: (q) => q.domain ? <Badge className="bg-teal-100 text-teal-800 text-xs">{IBDP_DOMAIN_LABELS[q.domain as keyof typeof IBDP_DOMAIN_LABELS] ?? q.domain}</Badge> : null },
...
export default function IBDPAIHLQCPage() {
