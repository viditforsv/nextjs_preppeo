...
Correct answer: ${q.correct_answer}`;
    ...
    if (mode === 'theory') {
      systemPrompt = `You are an expert CBSE Class 10 Mathematics tutor. Provide the underlying theory behind this question.
...
Use plain text. For math, use Unicode symbols (², √, ×, ÷) instead of LaTeX. Be thorough but concise.`;
      ...
      systemPrompt = `You are an expert CBSE Class 10 Mathematics tutor. Explain this question step by step.
...
Use plain text. For math, use Unicode symbols (², √, ×, ÷) instead of LaTeX. Keep it conversational and encouraging.`;
    ...
    console.error('Error in POST /api/admin/cbse10-maths-questions/regenerate-ai:', err);
