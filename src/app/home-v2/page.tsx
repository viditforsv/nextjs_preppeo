...
/* ── Score Report Mockup ──────────────────────────────────────── */
function ScoreReportMockup() {
  const domains = [
    { label: "Craft & Structure",            pct: 75, color: TEAL  },
    { label: "Information & Ideas",           pct: 57, color: NAVY  },
    { label: "Standard English Conventions",  pct: 83, color: AMBER },
    { label: "Expression of Ideas",           pct: 60, color: "#6366f1" },
  ];
  const mathDomains = [
    { label: "Algebra",                         pct: 80, color: NAVY  },
    { label: "Advanced Math",                   pct: 53, color: TEAL  },
    { label: "Problem-solving & Data Analysis", pct: 67, color: AMBER },
    { label: "Additional Topics",               pct: 50, color: "#6366f1" },
  ];

  return (
    <div className="rounded-xl border border-gray-200 shadow-sm overflow-hidden text-sm bg-white">
      {/* Header */}
      <div className="px-5 py-4 flex items-center justify-between" style={{ background: NAVY }}>
        <div>
          <p className="text-white/60 text-xs mb-0.5">Mock Test 1 · Reading &amp; Writing + Math</p>
          <p className="text-white font-bold text-lg">Score Report</p>
        </div>
        <div className="text-right">
          <p className="text-white/60 text-xs mb-0.5">Total Score</p>
          <p className="font-bold text-2xl" style={{ color: AMBER }}>1,280</p>
          <p className="text-white/50 text-xs">out of 1600</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 divide-x divide-gray-100 border-b border-gray-100">
        <div className="px-5 py-4">
          <p className="text-xs text-gray-400 mb-1">Reading &amp; Writing</p>
          <p className="text-2xl font-bold" style={{ color: NAVY }}>640</p>
          <p className="text-xs text-gray-400">Hard M2 — top track</p>
        </div>
        <div className="px-5 py-4">
      ...
      <div className="px-5 py-4 border-b border-gray-100">
        <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-3">R&amp;W by Domain</p>
      ...
      <div className="px-5 py-4">
        <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-3">Math by Domain</p>
        <div className="space-y-2.5">
          {mathDomains.map((d) => (
            <div key={d.label}>
              <div className="flex justify-between text-xs text-gray-600 mb-1">
      ...
      <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
        <p className="text-xs text-gray-400 text-center">
          + Difficulty breakdown · Time per question · Question-level review
        </p>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white border-b border-gray-100 py-20">
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div
            className="rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-center"
            style={{ minHeight: 360 }}
          >
            <div className="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center mb-4">
              <ClipboardCheck className="w-8 h-8 text-gray-300" />
            </div>
            <p className="text-sm font-semibold text-gray-400 mb-1">Screenshot coming soon</p>
            <p className="text-xs text-gray-300 max-w-[200px]">
              Platform screenshot / score report preview
            </p>
          </div>
