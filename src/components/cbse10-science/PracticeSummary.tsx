...
export default function PracticeSummary() {
  ...
  const handlePracticeAgain = () => {
    useCBSE10ScienceStore.setState({ phase: 'practice-config' });
  };

  return (
    <div className="min-h-screen bg-[#f5f5f0]">
      <div className="text-white px-4 py-4" style={{ backgroundColor: ACCENT_DARK }}>
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={goToLanding}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-white/10 hover:bg-white/20 rounded-lg transition-colors"
            >
              <ArrowLeft className="w-3.5 h-3.5" /> Back to Science
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-4">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="text-center mb-6">
            <p className="text-sm text-gray-500 mb-1">CBSE 10 Science Practice</p>
            <p className="text-5xl font-bold" style={{ color: ACCENT_DARK }}>{pct}%</p>
        ...
        {domainMap.size > 1 && (
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h3 className="text-sm font-semibold text-gray-700 mb-3">Chapter Breakdown</h3>
                ...
                return (
                  <div key={domain}>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2">
                      <div className="h-2 rounded-full transition-all" style={{ width: `${domPct}%`, backgroundColor: ACCENT }} />
                    </div>
                  </div>
                );
              })}
